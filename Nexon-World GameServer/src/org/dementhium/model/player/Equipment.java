...
public class Equipment {
    ...
    public static boolean isTwoHanded(ItemDefinition def) {
		String wepEquiped = def.getName().toLowerCase();
		...
		if (itemId == 4212)
			...
			return true;
		else if (wepEquiped.contains("zaryte"))
			return true;
		else if (wepEquiped.endsWith("shortbow"))
			return true;
		else if (wepEquiped.endsWith("bow full"))
			return true;
else if (wepEquiped.endsWith("Zamorakian spear"))
			return true;
else if (wepEquiped.endsWith("Gorgonite maul (b)"))
			return true;
else if (wepEquiped.endsWith("Gorgonite maul"))
			return true;
else if (wepEquiped.endsWith("Gravite 2h"))
			return true;
else if (wepEquiped.endsWith("Novite maul (b)"))
			return true;
else if (wepEquiped.endsWith("Bathus maul (b)"))
			return true;
else if (wepEquiped.endsWith("Marmaros maul (b)"))
			return true;
else if (wepEquiped.endsWith("Kratonite maul (b)"))
			return true;
else if (wepEquiped.endsWith("Fractite maul (b)"))
			return true;
else if (wepEquiped.endsWith("Zephyrium maul (b)"))
			return true;
else if (wepEquiped.endsWith("Argonite maul (b)"))
			return true;
else if (wepEquiped.endsWith("Katagon maul (b)"))
			return true;
else if (wepEquiped.endsWith("Promethium maul (b)"))
			return true;
else if (wepEquiped.endsWith("Primal maul (b)"))
			return true;
else if (wepEquiped.endsWith("Novite maul"))
			return true;
else if (wepEquiped.endsWith("Bathus maul"))
			return true;
else if (wepEquiped.endsWith("Marmaros maul"))
			return true;
else if (wepEquiped.endsWith("Kratonite maul"))
			return true;
else if (wepEquiped.endsWith("Fractite maul"))
			return true;
else if (wepEquiped.endsWith("Zephyrium maul"))
			return true;
else if (wepEquiped.endsWith("Argonite maul"))
			return true;
else if (wepEquiped.endsWith("Katagon maul"))
			return true;
else if (wepEquiped.endsWith("Promethium maul"))
			return true;
else if (wepEquiped.endsWith("Primal maul"))
			return true;
    ...
    public boolean degrades(ItemDefinition item) {
        ...
        return name.contains("Torva") || name.contains("Vesta") || name.contains("Chaotic");
    }
    ...
    public boolean voidSet(int setID) {
        ...
        boolean hasHelmet = helmet.contains(set);
        boolean hasTop = contains(8839) || contains(19785) || contains(19787) || contains(19789) || contains(17237);
        boolean hasGloves = contains(8842) || contains(17171);
        boolean hasBottom = contains(8840) || contains(19788) || contains(19788) || contains(19790) || contains(16865);
        ...
        if (amt == 2) {
            if (contains(19711) || contains(19617) || contains(19615) || contains(19613)) {
                amt++;
            }
        }
