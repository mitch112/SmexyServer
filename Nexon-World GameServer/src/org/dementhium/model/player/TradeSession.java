...
public class TradeSession {
        ...
        if (currentState.equals(TradeState.STATE_ONE)) {
            if (pl.equals(trader)) {
                ...
                if (item != null) {
                    ...
                    ActionSender.TradeIcons(trader, slot);
                    resetAccept();
                }
            }
            refreshScreen();
	...
	private void flashSlot(Player pl, int slot) {
		if (pl.equals(trader)) {
			ActionSender.sendClientScript(trader, 143, new Object[]{slot, 7, 4, 21954593}, "Iiii");
		} else if (pl.equals(partner)) {
			ActionSender.sendClientScript(partner, 143, new Object[]{slot, 7, 4, 21954593}, "Iiii");
		}
	}
