...
import org.dementhium.model.combat.impl.npc.EliteAction;
...
public class Elite extends NPC {
	 ...
	 */
	private static CombatAction combatAction = new EliteAction();
	
    /**
     * Constructs a new {@code Elite} {@code Object}.
     *
     * @param id The npc id.
     */
    public Elite(int id) {
