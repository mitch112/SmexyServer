...
public class ShadowBlitz extends MagicSpell {
	...
	public boolean castSpell(Interaction interaction) {
		if (interaction.getSource().getPlayer().getSkills().getLevel(Skills.MAGIC) < 76) {
			interaction.getSource().getPlayer().sendMessage("You need a level of 76 Magic to use shadow blitz.");
			return false;
		}
