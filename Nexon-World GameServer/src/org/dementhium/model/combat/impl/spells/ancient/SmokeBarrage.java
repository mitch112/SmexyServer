...
public class SmokeBarrage extends MagicSpell {
	...
	public boolean castSpell(Interaction interaction) {
		if (interaction.getSource().getPlayer().getSkills().getLevel(Skills.MAGIC) < 86) {
			interaction.getSource().getPlayer().sendMessage("You need a level of 86 Magic to use smoke barrage.");
			return false;
		}
