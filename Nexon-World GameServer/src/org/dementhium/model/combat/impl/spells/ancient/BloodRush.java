...
public class BloodRush extends MagicSpell {
	...
	public boolean castSpell(Interaction interaction) {
		if (interaction.getSource().getPlayer().getSkills().getLevel(Skills.MAGIC) < 56) {
			interaction.getSource().getPlayer().sendMessage("You need a level of 56 Magic to use blood rush.");
			return false;
		}
