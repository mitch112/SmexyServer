...
public class AirBolt extends MagicSpell {
	...
	public boolean castSpell(Interaction interaction) {
		if (interaction.getSource().getPlayer().getSkills().getLevel(Skills.MAGIC) < 17) {
			interaction.getSource().getPlayer().sendMessage("You need a level of 17 Magic to use air bolt.");
			return false;
		}
