...
public class FireSurge extends MagicSpell {
	...
	public boolean castSpell(Interaction interaction) {
		...
		ProjectileManager.sendProjectile(Projectile.create(interaction.getSource(), interaction.getVictim(), 2939, 22, 32, 60, speed, 0, 90));
		interaction.getSource().animate(15080);
		interaction.getSource().graphics(-1, 0);
		interaction.setEndGraphic(Graphic.create(2942, 96 << 16));
		} else {
