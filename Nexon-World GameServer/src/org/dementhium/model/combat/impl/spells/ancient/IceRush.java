...
public class IceRush extends MagicSpell {
	...
	public boolean castSpell(Interaction interaction) {
		if (interaction.getSource().getPlayer().getSkills().getLevel(Skills.MAGIC) < 58) {
			interaction.getSource().getPlayer().sendMessage("You need a level of 58 Magic to use ice rush.");
			return false;
		}
