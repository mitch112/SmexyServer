...
public class EarthWave extends MagicSpell {
	...
	public boolean castSpell(Interaction interaction) {
		if (interaction.getSource().getPlayer().getSkills().getLevel(Skills.MAGIC) < 70) {
			interaction.getSource().getPlayer().sendMessage("You need a level of 70 Magic to use earth wave.");
			return false;
		}
