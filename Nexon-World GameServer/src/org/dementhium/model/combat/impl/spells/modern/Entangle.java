...
public class Entangle extends MagicSpell {
	...
	public boolean castSpell(Interaction interaction) {
		if (interaction.getSource().getPlayer().getSkills().getLevel(Skills.MAGIC) < 79) {
			interaction.getSource().getPlayer().sendMessage("You need a level of 79 Magic to use entangle.");
			return false;
		}
