...
public class FireWave extends MagicSpell {
	...
	public boolean castSpell(Interaction interaction) {
		if (interaction.getSource().getPlayer().getSkills().getLevel(Skills.MAGIC) < 75) {
			interaction.getSource().getPlayer().sendMessage("You need a level of 75 Magic to use fire wave.");
			return false;
		}
