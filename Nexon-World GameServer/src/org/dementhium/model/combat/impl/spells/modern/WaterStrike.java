...
public class WaterStrike extends MagicSpell {
	...
	public boolean castSpell(Interaction interaction) {
		if (interaction.getSource().getPlayer().getSkills().getLevel(Skills.MAGIC) < 5) {
			interaction.getSource().getPlayer().sendMessage("You need a level of 5 Magic to use water strike.");
			return false;
		}
