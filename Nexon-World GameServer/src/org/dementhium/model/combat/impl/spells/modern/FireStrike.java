...
public class FireStrike extends MagicSpell {
	...
	public boolean castSpell(Interaction interaction) {
		if (interaction.getSource().getPlayer().getSkills().getLevel(Skills.MAGIC) < 13) {
			interaction.getSource().getPlayer().sendMessage("You need a level of 13 Magic to use fire strike.");
			return false;
		}
