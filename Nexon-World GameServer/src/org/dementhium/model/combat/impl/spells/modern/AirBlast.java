...
public class AirBlast extends MagicSpell {
	...
	public boolean castSpell(Interaction interaction) {
		if (interaction.getSource().getPlayer().getSkills().getLevel(Skills.MAGIC) < 41) {
			interaction.getSource().getPlayer().sendMessage("You need a level of 41 Magic to use air blast.");
			return false;
		}
