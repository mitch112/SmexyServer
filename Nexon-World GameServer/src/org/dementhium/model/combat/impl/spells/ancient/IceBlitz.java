...
public class IceBlitz extends MagicSpell {
	...
	public boolean castSpell(Interaction interaction) {
		if (interaction.getSource().getPlayer().getSkills().getLevel(Skills.MAGIC) < 82) {
			interaction.getSource().getPlayer().sendMessage("You need a level of 82 Magic to use ice blitz.");
			return false;
		}
