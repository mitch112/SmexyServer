...
public class IceBarrage extends MagicSpell {
	...
	public boolean castSpell(Interaction interaction) {
		if (interaction.getSource().getPlayer().getSkills().getLevel(Skills.MAGIC) < 94) {
			interaction.getSource().getPlayer().sendMessage("You need a level of 94 Magic to use ice barrage.");
			return false;
		}
