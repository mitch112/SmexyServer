...
public class BloodBlitz extends MagicSpell {
	...
	public boolean castSpell(Interaction interaction) {
		if (interaction.getSource().getPlayer().getSkills().getLevel(Skills.MAGIC) < 80) {
			interaction.getSource().getPlayer().sendMessage("You need a level of 80 Magic to use blood blitz.");
			return false;
		}
