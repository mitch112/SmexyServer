...
public class SmokeBurst extends MagicSpell {
	...
	public boolean castSpell(Interaction interaction) {
		if (interaction.getSource().getPlayer().getSkills().getLevel(Skills.MAGIC) < 62) {
			interaction.getSource().getPlayer().sendMessage("You need a level of 62 Magic to use smoke burst.");
			return false;
		}
