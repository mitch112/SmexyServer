...
public class Bind extends MagicSpell {
	...
	public boolean castSpell(Interaction interaction) {
		if (interaction.getSource().getPlayer().getSkills().getLevel(Skills.MAGIC) < 20) {
			interaction.getSource().getPlayer().sendMessage("You need a level of 20 Magic to use bind.");
			return false;
		}
