...
public class BloodBurst extends MagicSpell {
	...
	public boolean castSpell(Interaction interaction) {
		if (interaction.getSource().getPlayer().getSkills().getLevel(Skills.MAGIC) < 68) {
			interaction.getSource().getPlayer().sendMessage("You need a level of 68 Magic to use blood barrage.");
			return false;
		}
