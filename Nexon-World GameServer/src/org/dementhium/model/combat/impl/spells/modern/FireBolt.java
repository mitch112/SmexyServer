...
public class FireBolt extends MagicSpell {
	...
	public boolean castSpell(Interaction interaction) {
		if (interaction.getSource().getPlayer().getSkills().getLevel(Skills.MAGIC) < 35) {
			interaction.getSource().getPlayer().sendMessage("You need a level of 35 Magic to use fire bolt.");
			return false;
		}
