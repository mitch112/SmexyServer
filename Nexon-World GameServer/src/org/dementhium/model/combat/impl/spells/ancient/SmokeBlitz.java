...
public class SmokeBlitz extends MagicSpell {
	...
	public boolean castSpell(Interaction interaction) {
		if (interaction.getSource().getPlayer().getSkills().getLevel(Skills.MAGIC) < 74) {
			interaction.getSource().getPlayer().sendMessage("You need a level of 74 Magic to use smoke blitz.");
			return false;
		}
