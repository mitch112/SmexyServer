...
public class EarthBolt extends MagicSpell {
	...
	public boolean castSpell(Interaction interaction) {
		if (interaction.getSource().getPlayer().getSkills().getLevel(Skills.MAGIC) < 29) {
			interaction.getSource().getPlayer().sendMessage("You need a level of 29 Magic to use earth bolt.");
			return false;
		}
