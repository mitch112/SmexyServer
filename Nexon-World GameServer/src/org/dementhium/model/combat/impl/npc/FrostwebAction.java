 ...
 * @author Wildking72
 */
public class FrostwebAction extends CombatAction {
	...
	int type = RANDOM.nextInt(4);
		...
		if (interaction.getSource().getRandom().nextInt(10) < 5) {
			...
			if (first < 1) {
				...
				interaction.getSource().forceText("You will not leave me forgotten again!");
				...
				interaction.getSource().forceText("Feel the power of MAGE!");
				interaction.getVictim().getPoisonManager().poison(interaction.getSource(), 61);
			...
			interaction.getDamage().setMaximum(371);
			return true;
		}
