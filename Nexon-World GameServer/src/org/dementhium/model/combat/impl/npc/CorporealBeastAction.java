...
import org.dementhium.model.npc.impl.CorporealBeast;
...
public class CorporealBeastAction extends CombatAction {
	...
	private static enum Attack {
		MELEE(Animation.create(10057), null, null, null),
		RANGE(Animation.create(10057), Graphic.create(1825), 
				Projectile.create(null, null, 1825, 46, 32, 56, 75, 3, 11), Graphic.create(-1)),
		MAGIC(Animation.create(10055), Graphic.create(1824), 
				Projectile.create(null, null, 1824, 46, 32, 56, 75, 3, 11), Graphic.create(1883, 96 << 16));
	 ...
	 */
	public static void sendLocationAttack(final CorporealBeast demon) {
