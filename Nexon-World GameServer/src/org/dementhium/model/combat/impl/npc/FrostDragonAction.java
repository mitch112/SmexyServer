...
/**
 * Represents the Frost dragon combat action.
 * @author Emperor
 *
 */
public class FrostDragonAction extends CombatAction {
     ...
     */
    private static final Animation BITE_ANIMATION = Animation.create(13151);
    ...
    /**
     * Constructs a new {@code FrostDragonAction} {@code Object}.
     */
