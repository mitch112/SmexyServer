...
public class Fletching extends ProduceAction {
	...
	public static final Item BROAD_HEAD_15 = new Item(13278, 15);
    ...
    public enum FletchingItem {
        ...
        * Attaching
        */
		BROAD_UNFINISHED(55, 50.5, null, new Item[]{BROAD_HEAD_15, new Item(52, 15)}, new Item(13279, 15), FletchingType.ATTACHING),
		...
		*/
		...
		BROAD_BOLTS(55, 52.5, null, new Item[]{new Item(13279, 15), new Item(314, 15)}, new Item(13280, 15), FletchingType.ATTACHING),
