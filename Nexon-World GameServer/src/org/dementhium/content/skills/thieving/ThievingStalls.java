...
public enum ThievingStalls {
	...
	BAKER_STALL(new int[] { 34384 }, new int[] { 34381 }, 1, 20.0, 4, new Item(1891), new Item(1901), new Item(2309)),
	CRAFTING_STALL(new int[] {4874}, new int[] {4874}, 1, 20.0, 1, new Item(950)),
	MONKEY_FOOD_STALL(new int[] {4875}, new int[] {4875}, 25, 50.0, 1, new Item(1897)),
	MONKEY_GENERAL_STORE(new int[] {4876}, new int[] {4876}, 45, 90.0, 1, new Item(1397)),
	...
	MAGIC_STALL(new int[] {4877}, new int[] {4877}, 75, 170.0, 1, new Item(7650)),
	SCIMITAR_STALL(new int[] {4878}, new int[] {4878}, 60, 120.0, 1, new Item(1247)),
