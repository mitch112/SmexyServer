...
public class Mining extends HarvestAction {
	...
	public static int[] Gems = {2380, 2381, 2382, 2383};
	...
	DRAGON(15259, 61, Animation.create(10007)),
    ...
    public static enum Rock implements HarvestObject {
        ...
        COPPER(436, 1, 17.5, 3, new int[]{5780, 5779, 5781, 11936, 11937, 11938, 11960, 11961, 11962, 31080, 31081, 31082}),
        TIN(438, 1, 17.5, 3, new int[]{5776, 5777, 5778, 11933, 11934, 11935, 11957, 11958, 11959, 31077, 31078, 31079}),
        IRON(440, 15, 35, 5, new int[]{5773, 5774, 5775, 11954, 11955, 11956, 14856, 14857, 14858, 31071, 31072, 31073, 32441, 32442, 32443, 37307, 37308, 37309}),
        ...
        COAL(453, 30, 50, 10, new int[]{5770, 5771, 5772, 11930, 11931, 11932, 14850, 14851, 14852, 31068, 31069, 31070, 32426, 32427, 32428}),
        MITHRIL(447, 55, 80, 15, new int[]{5784, 5786, 11942, 11943, 11944, 11945, 11946, 11947, 14853, 14854, 14855, 31086, 31087, 31088, 32438, 32439, 32440}),
        ADAMANTITE(449, 70, 95, 25, new int[]{5782, 5783, 11939, 11940, 11941, 11963, 11964, 11965, 14862, 14863, 14864, 31083, 31084, 31085, 32435, 32436, 32437}),
        RUNE(451, 85, 125, 30, new int[]{14859, 14860, 14861}),
        ESSENCE(1436 << 16 | 7936, 1, 5, -1, new int[] {2491}),
	CRYSTAL1(2380 << 16 | 2380, 80, 122.5, -1, new int[] {4926}),
	CRYSTAL2(2381 << 16 | 2381, 80, 122.5, -1, new int[] {4927}),
	CRYSTAL3(2382 << 16 | 2382, 80, 122.5, -1, new int[] {4928}),
	VIEN_ADAMANT(449 << 16 | 449, 80, 190, -1, new int[] {20115, 20116, 20117}),
	VIEN_MITHRIL(447 << 16 | 447, 80, 160, -1, new int[] {20419, 20420, 20421}),
	VIEN_COAL(453 << 16 | 453, 1, 100, -1, new int[] {20411, 20410, 20412, 20413});
