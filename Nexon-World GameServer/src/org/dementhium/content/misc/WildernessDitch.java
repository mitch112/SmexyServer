    ...
    public boolean objectOption(Player player, int objectId, GameObject gameObject, Location location, ClickOption option) {
        if (option == ClickOption.FIRST) {
            if (gameObject.getId() >= 1440 && gameObject.getId() <= 1444) {
            	...
            	if( player.getLocation().getY() == 3520 || player.getLocation().getY() == 3519 || player.getLocation().getY() == 3518 || player.getLocation().getY() == 3517 || player.getLocation().getY() == 3516 || player.getLocation().getY() == 3515 || player.getLocation().getY() == 3514) {
