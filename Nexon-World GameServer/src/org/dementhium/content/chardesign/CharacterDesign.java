package org.dementhium.content.chardesign;

import org.dementhium.content.chardesign.DefaultDesign.DefaultSubDesign;
...
public class CharacterDesign extends EventListener {
	...
	public boolean interfaceOption(final Player player, int interfaceId, int buttonId, int buttonId2, int itemId, int opcode) {
		...
		case 100:
			...
			break;
		case 45:
			app.setColor(4, SKIN_COLOURS[buttonId2]);
			break;
		case 107:
			if (app.getGender() == Appearance.Gender.MALE) {
				switch (des.customIndex) {
				case HAIR:
					app.setLook(0, MALE_HAIR_LOOKS[buttonId2]);
					break;
				case TORSO:
					int[] torso = MALE_TORSO_LOOKS[buttonId2];
					...
					break;
				case LEGS:
					app.setLook(5, MALE_LEG_LOOKS[buttonId2]);
					break;
				case SHOES:
					app.setLook(6, MALE_FEET_LOOKS[buttonId2]);
					break;
				case FACIAL_HAIR:
					app.setLook(1, MALE_FACIAL_LOOKS[buttonId2]);
					break;
				}
			} else {
				switch (des.customIndex) {
				case HAIR:
					app.setLook(0, FEMALE_HAIR_LOOKS[buttonId2]);
					break;
				case TORSO:
					int[] torso = FEMALE_TORSO_LOOKS[buttonId2];
					app.setLook(2, torso[0] == -1 ? 0 : torso[0]);
					int arms = torso[1];
					if (arms != -1)
						app.setLook(3, torso[1]);
					...
					break;
				case LEGS:
					app.setLook(5, FEMALE_LEG_LOOKS[buttonId2]);
					break;
				case SHOES:
					app.setLook(6, FEMALE_FEET_LOOKS[buttonId2]);
					break;
				}
			}
			break;
		case 111: // modify colours
			...
			case SKIN:
				...
				break;
			case HAIR:
				app.setColor(0, HAIR_COLOURS[buttonId2]);
				break;
			case TORSO:
				app.setColor(1, CLOTH_COLOURS[buttonId2]);
				break;
			case LEGS:
				app.setColor(2, CLOTH_COLOURS[buttonId2]);
				break;
			case SHOES:
				app.setColor(3, FEET_COLOURS[buttonId2]);
				break;
			case FACIAL_HAIR:
				if (app.getGender() == Appearance.Gender.MALE) {
					app.setColor(0, HAIR_COLOURS[buttonId2]);
		...
		case 38:
			...
			break;
		case 39:
			if (app.getGender() != Appearance.Gender.FEMALE) {
				app.setGender(Appearance.Gender.FEMALE);
				app.setLook(0, 48);
				app.setLook(1, 1000);
				app.setLook(2, 57);
				app.setLook(3, 64);
		...
		case 120:
			...
			ActionSender.sendConfig(player, 1016, index);
	...
	public static void initiate(Player player, Appearance app) {
		...
		//ActionSender.sendInterfaceScript(player, 4244);
		app.getGender();
	}
	...
	public static void randomizeLook(Player player, Appearance app) {
		...
		/*        ActionSender.sendInterfaceVariable(player, 1008, hairIndex);
        ActionSender.sendInterfaceVariable(player, 1009, facialIndex);
        ActionSender.sendInterfaceVariable(player, 1010, torsoIndex);
        ActionSender.sendInterfaceVariable(player, 1013, legIndex);
        ActionSender.sendInterfaceVariable(player, 1014, feetIndex);
        ActionSender.sendInterfaceVariable(player, 1015, app.getColor(0));
        ActionSender.sendInterfaceVariable(player, 1016, app.getColor(1));
        ActionSender.sendInterfaceVariable(player, 1017, app.getColor(2));
        ActionSender.sendInterfaceVariable(player, 1018, app.getColor(3));
        ActionSender.sendInterfaceVariable(player, 1019, app.getColor(4));*/
	}
	...
	public static final DefaultDesign[] MALE_DEFAULT_DESIGNS = new DefaultDesign[]{
		new DefaultDesign(new DefaultSubDesign[]{ // ADVENTURER
				...
				new DefaultSubDesign(new int[][]{ // ADVENTURER #2
						{2, 443},
						{3, -1},
						{4, 390},
						{5, 646},
				...
				new DefaultSubDesign(new int[][]{ // ADVENTURER #3
						{2, 472},
						{3, 615},
						{4, 391},
						{5, 647},
				...
				new DefaultSubDesign(new int[][]{ // ADVENTURER #4
						{2, 473},
						{3, 616},
						{4, 392},
						{5, 648},
				...
				new DefaultSubDesign(new int[][]{ // ADVENTURER #5
						{2, 444},
						{3, -1},
						{4, 393},
						{5, 649},
				...
				new DefaultSubDesign(new int[][]{ // ADVENTURER #6
						{2, 474},
						{3, 618},
						{4, 394},
						{5, 650},
		...
		new DefaultDesign(new DefaultSubDesign[]{ // WARRIOR
				...
				new DefaultSubDesign(new int[][]{ // WARRIOR #2
				...
				new DefaultSubDesign(new int[][]{ // WARROR #3
		...
		new DefaultDesign(new DefaultSubDesign[]{ // MAGE
				...
				new DefaultSubDesign(new int[][]{ // MAGE #2
						{2, 448},
						{3, -1},
						{4, 387},
						{5, 643},
				...
				new DefaultSubDesign(new int[][]{ // MAGE #3
						{2, 449},
						{3, -1},
						{4, 388},
						{5, 644},
		...
		new DefaultDesign(new DefaultSubDesign[]{ // RANGER
				...
				new DefaultSubDesign(new int[][]{ // RANGER #2
						{2, 470},
						{3, 608},
						{4, 384},
						{5, 640},
				...
				new DefaultSubDesign(new int[][]{ // RANGER #3
		...
		new DefaultDesign(new DefaultSubDesign[]{ // SLAYER
		...
		new DefaultDesign(new DefaultSubDesign[]{ // THIEF
		...
		new DefaultDesign(new DefaultSubDesign[]{ // ATHLETE
		...
		new DefaultDesign(new DefaultSubDesign[]{ // HUNTER
		...
		new DefaultDesign(new DefaultSubDesign[]{ // CHEF
		...
		new DefaultDesign(new DefaultSubDesign[]{ // WOODCUTTER
		...
		new DefaultDesign(new DefaultSubDesign[]{ // FISHER
		...
		new DefaultDesign(new DefaultSubDesign[]{ // PRIEST
		...
		new DefaultDesign(new DefaultSubDesign[]{ // MINER
		...
		new DefaultDesign(new DefaultSubDesign[]{ // FARMER
		...
		new DefaultDesign(new DefaultSubDesign[]{ // SMITH
				...
				new DefaultSubDesign(new int[][]{ // SMITH #2
		...
		new DefaultDesign(new DefaultSubDesign[]{ // CRAFTER
		...
		new DefaultDesign(new DefaultSubDesign[]{ // FLETCHER
		...
		new DefaultDesign(new DefaultSubDesign[]{ // HERBLORIST
		...
		new DefaultDesign(new DefaultSubDesign[]{ // SUMMONER
		...
		new DefaultDesign(new DefaultSubDesign[]{ // RUNECRAFTER
	...
	public static final DefaultDesign[] FEMALE_DEFAULT_DESIGNS = new DefaultDesign[]{
		...
		new DefaultDesign(new DefaultSubDesign[]{ // WARRIOR
				...
				new DefaultSubDesign(new int[][]{ // WARRIOR #3
		...
		new DefaultDesign(new DefaultSubDesign[]{ // PRIESTESS
