...
final class Class78
{
    ...
    static final void method790(int i, int i_0_, int i_1_,
				Class246_Sub3_Sub3 class246_sub3_sub3,
				Class246_Sub3_Sub3 class246_sub3_sub3_2_) {
	Class172 class172 = Class100.method1693(i, i_0_, i_1_);
	if (class172 != null) {
	    ((Class172) class172).aClass246_Sub3_Sub3_1324
		= class246_sub3_sub3;
	    ((Class172) class172).aClass246_Sub3_Sub3_1333
		...
		if (class246_sub3_sub3.method2987(6540)) {
		    ((Class246_Sub3) class246_sub3_sub3).aClass246_Sub3_5090
			= Class359.aClass246_Sub3Array3056[i_3_];
		    Class359.aClass246_Sub3Array3056[i_3_]
			= class246_sub3_sub3;
		} else {
		    ((Class246_Sub3) class246_sub3_sub3).aClass246_Sub3_5090
			= Class379.aClass246_Sub3Array3198[i_3_];
		    Class379.aClass246_Sub3Array3198[i_3_]
			= class246_sub3_sub3;
		...
		((Class246_Sub3) class246_sub3_sub3).aClass246_Sub3_5090
		    = Class130.aClass246_Sub3Array1029[i_3_];
		...
		if (class246_sub3_sub3_2_.method2978(-126)) {
			...
			((Class246_Sub3) class246_sub3_sub3_2_)
			    .aClass246_Sub3_5090
			    = Class359.aClass246_Sub3Array3056[i_3_];
			Class359.aClass246_Sub3Array3056[i_3_]
			    = class246_sub3_sub3_2_;
		    ...
		    ((Class246_Sub3) class246_sub3_sub3_2_).aClass246_Sub3_5090
			= Class130.aClass246_Sub3Array1029[i_3_];
		    Class130.aClass246_Sub3Array1029[i_3_]
			= class246_sub3_sub3_2_;
		}
	...
	do {
		...
		if (i == 102) {
		    ...
		    try {
			Class143 class143 = Class98_Sub43_Sub2
						.aClass88_5907
			...
			if (class143.anInt1163 == 1) {
			    ...
			    byte[] is
				= (new byte
				   [(int) class356.method3878((byte) -60)]);
			    int i_4_;
			    ...
			    Class31.method306(i ^ 0x270c,
					      new Class98_Sub22(is));
			}
