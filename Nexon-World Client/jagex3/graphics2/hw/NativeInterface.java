...
public class NativeInterface
{
	...
	(short[] is, short[] is_15_, short[] is_16_, byte[] is_17_, float f,
	 float f_18_, int i, int i_19_, int i_20_, long l);
    
    public final native void copyLighting
	(short[] is, byte[] is_21_, short[] is_22_, short[] is_23_,
	 short[] is_24_, short[] is_25_, byte[] is_26_, int i, int i_27_,
	 short[] is_28_, int i_29_, int i_30_, int i_31_, long l);
    
    public final native void copyColours
	(short[] is, byte[] is_32_, short[] is_33_, int i, short[] is_34_,
	 int i_35_, int i_36_, int i_37_, long l);
    
    public NativeInterface(int i, int i_38_) {
	try {
	    init(i, i_38_);
    ...
    public final native void setSunDirection(float f, float f_39_,
					     float f_40_);
}
