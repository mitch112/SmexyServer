...
final class Class98_Sub46_Sub14 extends Class98_Sub46 implements Interface3
{
	...
	Class172 class172
	    = Class98_Sub46_Sub1.aClass172ArrayArrayArray5948[i][i_0_][i_1_];
	if (class172 != null) {
	    Class129
		.method2227(((Class172) class172).aClass246_Sub3_Sub1_1332);
	    if (((Class172) class172).aClass246_Sub3_Sub1_1332 != null)
		((Class172) class172).aClass246_Sub3_Sub1_1332 = null;
	}
    }
    
    final void method1603(int i) {
	try {
	    if (i < anInt5381) {
    ...
    static final void method1604(boolean bool, byte i) {
	try {
    ...
    final void method1605(int i, int i_2_, int i_3_) {
	do {
	    try {
    ...
    static final boolean method1607(Class228 class228, byte i) {
	try {
	    if (i < 80)
		method1607(null, (byte) 113);
	    if (class228 == null)
		return false;
	    return s_Sub1.method3427(((Class228) class228).anInt1713,
				     (((Class228) class228).anInt1714
				      - ((Class228) class228).anInt1712),
				     (((Class228) class228).anInt1708
				      - ((Class228) class228).anInt1713),
				     (((Class228) class228).anInt1709
				      - ((Class228) class228).anInt1715),
				     (byte) 16,
				     ((Class228) class228).anInt1715,
				     ((Class228) class228).anInt1712);
	} catch (RuntimeException runtimeexception) {
	...
	try {
	    OpenGL.glFramebufferRenderbufferEXT(anInt5375, anInt5380, 36161,
						0);
	    if (i > -117)
    ...
    Class98_Sub46_Sub14(ha_Sub1 var_ha_Sub1, int i, int i_4_, int i_5_) {
	try {
	    anInt5379 = i;
	    ...
	    OpenGL.glRenderbufferStorageEXT(36161, anInt5379,
					    (((Class98_Sub46_Sub14) this)
					     .anInt5376),
					    (((Class98_Sub46_Sub14) this)
					     .anInt5377));
	    anInt5374 = (((Class98_Sub46_Sub14) this).anInt5376
			 * (((Class98_Sub46_Sub14) this).anInt5377
			    * aHa_Sub1_5373.method1866(-96, anInt5379)));
	} catch (RuntimeException runtimeexception) {
	    throw Class64_Sub27.method667(runtimeexception,
					  ("is.<init>("
					   + (var_ha_Sub1 != null ? "{...}"
    ...
    Class98_Sub46_Sub14(ha_Sub1 var_ha_Sub1, int i, int i_6_, int i_7_,
			int i_8_) {
	try {
	    aHa_Sub1_5373 = var_ha_Sub1;
	    anInt5379 = i;
		...
		(36161, i_8_, anInt5379,
		 ((Class98_Sub46_Sub14) this).anInt5376,
		 ((Class98_Sub46_Sub14) this).anInt5377);
	    anInt5374 = (((Class98_Sub46_Sub14) this).anInt5377
			 * ((Class98_Sub46_Sub14) this).anInt5376
			 * aHa_Sub1_5373.method1866(-121, anInt5379));
	} catch (RuntimeException runtimeexception) {
	    throw Class64_Sub27.method667(runtimeexception,
					  ("is.<init>("
					   + (var_ha_Sub1 != null ? "{...}"
