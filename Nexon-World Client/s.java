...
abstract class s
{
	...
	try {
	    ...
	    if ((i_5_ ^ 0xffffffff) > -1 || i_6_ < 0
		|| ((s) this).anInt2203 + -1 < i_5_
		|| i_6_ > -1 + ((s) this).anInt2204)
		return 0;
	    int i_7_ = i & -1 + ((s) this).anInt2206;
	    int i_8_ = i_4_ & ((s) this).anInt2206 - 1;
	    int i_9_
		= ((((-i_7_ + ((s) this).anInt2206)
		     * ((s) this).anIntArrayArray2201[i_5_][i_6_])
		    + i_7_ * ((s) this).anIntArrayArray2201[1 + i_5_][i_6_])
		   >> ((s) this).anInt2200);
	    int i_10_
		= ((((-i_7_ + ((s) this).anInt2206)
		     * ((s) this).anIntArrayArray2201[i_5_][1 + i_6_])
		    - -(((s) this).anIntArrayArray2201[i_5_ - -1][1 + i_6_]
			* i_7_))
		   >> ((s) this).anInt2200);
	    return (i_8_ * i_10_ + (((s) this).anInt2206 - i_8_) * i_9_
		    >> ((s) this).anInt2200);
    ...
    abstract void U(int i, int i_18_, int[] is, int[] is_19_, int[] is_20_,
		    ...
		    int[] is_25_, int i_26_, int i_27_, int i_28_,
		    boolean bool);
    ...
    abstract void method3424(int i, int i_41_, int[] is, int[] is_42_,
			     int[] is_43_, int[] is_44_, int[] is_45_,
			     int[] is_46_, int[] is_47_, int[] is_48_,
			     int[] is_49_, int[] is_50_, int[] is_51_,
			     int i_52_, int i_53_, int i_54_, boolean bool);
