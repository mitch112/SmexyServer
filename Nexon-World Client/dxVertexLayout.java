...
public class dxVertexLayout extends Class256
{
	...
	try {
		...
		= new VertexElementCollection(((ha_Sub3_Sub1) var_ha_Sub3_Sub1)
					      .aJaa6108);
	    int i = 0;
	    for (int i_0_ = 0; class49s.length > i_0_; i_0_++) {
		int i_1_ = 0;
		Class49 class49 = class49s[i_0_];
		for (int i_2_ = 0; i_2_ < class49.method480((byte) -105);
		     i_2_++) {
		    Class169 class169 = class49.method479(i_2_, (byte) -98);
			...
			if (class169 == Class169.aClass169_1299)
				...
				if (class169 == Class169.aClass169_1303)
				    vertexelementcollection
					.addElement(i_0_, 3, 0, 5, i++, i_1_);
			    } else
				vertexelementcollection
				    .addElement(i_0_, 2, 0, 5, i++, i_1_);
			} else
	    ...
	    ((dxVertexLayout) this).anIDirect3DVertexDeclaration5155
		= ((ha_Sub3_Sub1) var_ha_Sub3_Sub1).anIDirect3DDevice6098
