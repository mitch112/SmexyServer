...
final class Class71
{
	...
	int[] is = new int[anInt531];
	int[] is_0_ = new int[33];
	for (int i = 0; i < anInt531; i++) {
	    int i_1_ = anIntArray534[i];
	    if (i_1_ != 0) {
		int i_2_ = 1 << 32 - i_1_;
		int i_3_ = is_0_[i_1_];
		is[i] = i_3_;
	...
	for (int i_10_ = 0; i_10_ < anInt531; i_10_++) {
		...
		for (int i_14_ = 0; i_14_ < i_11_; i_14_++) {
			...
			int[] is_16_ = new int[anIntArray535.length * 2];
			for (int i_17_ = 0; i_17_ < anIntArray535.length;
			     i_17_++)
	...
	for (i_19_ = (int) Math.pow((double) i, 1.0 / (double) i_18_) + 1;
	     Class98_Sub49.method1662(i_19_, -1, i_18_) > i; i_19_--) {
	    /* empty */
	}
	return i_19_;
    }
    ...
    final int method714() {
	int i;
	for (i = 0; anIntArray535[i] >= 0;
	     i = Class98_Sub13.method1134() != 0 ? anIntArray535[i] : i + 1) {
	    /* empty */
	}
	...
	if (bool) {
	    ...
	    while (i < anInt531) {
		int i_21_
		    = (Class98_Sub13.method1138
		       (Class48_Sub2_Sub1.method474(anInt531 - i, (byte) 31)));
		for (int i_22_ = 0; i_22_ < i_21_; i_22_++)
		    anIntArray534[i++] = i_20_;
		i_20_++;
	    }
	} else {
	    boolean bool_23_ = Class98_Sub13.method1134() != 0;
	    for (int i = 0; i < anInt531; i++) {
	...
	method712();
	int i = Class98_Sub13.method1138(4);
	if (i > 0) {
	    float f = Class98_Sub13.method1139(Class98_Sub13.method1138(32));
	    float f_24_
		= Class98_Sub13.method1139(Class98_Sub13.method1138(32));
	    int i_25_ = Class98_Sub13.method1138(4) + 1;
	    ...
	    aFloatArrayArray533
		= new float[anInt531][((Class71) this).anInt530];
	    if (i == 1) {
		for (int i_29_ = 0; i_29_ < anInt531; i_29_++) {
		    float f_30_ = 0.0F;
		    int i_31_ = 1;
		    for (int i_32_ = 0; i_32_ < ((Class71) this).anInt530;
			 i_32_++) {
			int i_33_ = i_29_ / i_31_ % i_27_;
			float f_34_
			    = (float) anIntArray532[i_33_] * f_24_ + f + f_30_;
		...
		for (int i_35_ = 0; i_35_ < anInt531; i_35_++) {
		    ...
		    for (int i_38_ = 0; i_38_ < ((Class71) this).anInt530;
			 i_38_++) {
			float f_39_
			    = (float) anIntArray532[i_37_] * f_24_ + f + f_36_;
