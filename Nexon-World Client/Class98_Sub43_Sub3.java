...
final class Class98_Sub43_Sub3 extends Class98_Sub43
{
	...
	try {
		...
		return 0.0F;
	    return ((float) aTheoraInfo5914.fpsNumerator
		    / (float) aTheoraInfo5914.fpsDenominator);
	} catch (RuntimeException runtimeexception) {
	...
	do {
		...
		do {
			...
			if ((i ^ 0xffffffff) == -1) {
			    ...
			    aDecoderContext5923
				= new DecoderContext(aTheoraInfo5914,
						     aSetupInfo5928);
			    aGranulePos5918 = new GranulePos();
			    aFrame5911
				= new Frame(aTheoraInfo5914.frameWidth,
			...
			int i
			    = aDecoderContext5923
				  .decodePacketIn(oggpacket, aGranulePos5918);
			if ((i ^ 0xffffffff) > -1)
			    throw new IllegalStateException(String.valueOf(i));
			aDecoderContext5923.granuleFrame(aGranulePos5918);
			aDouble5915
			    = aDecoderContext5923.granuleTime(aGranulePos5918);
			if (aBoolean5916) {
			    boolean bool_2_
			...
			if (!aBoolean5913
			    || (oggpacket.isKeyFrame() ^ 0xffffffff) == -2) {
			    if ((aDecoderContext5923.decodeFrame(aFrame5911)
				 ^ 0xffffffff)
				!= -1)
				throw new IllegalStateException
					  (String.valueOf(i));
	...
	try {
		...
		return null;
	    aClass332_5917
		= var_ha.method1770(aFrame5911.pixels, 0, aFrame5911.a,
				    aFrame5911.a, aFrame5911.b, false);
	    aBoolean5912 = false;
	    return aClass332_5917;
	} catch (RuntimeException runtimeexception) {
	    throw Class64_Sub27.method667(runtimeexception,
