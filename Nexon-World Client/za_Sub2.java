...
final class za_Sub2 extends za
{
    ...
    static final void method1685(int i, int i_7_, int i_8_, boolean bool,
	...
	do {
		...
		do {
			...
			&& Class3.anInt77 >= i_7_
			&& ((Class76_Sub8.anInt3778 ^ 0xffffffff)
			    >= (i ^ 0xffffffff))
			...
			&& (Class3.anInt77 ^ 0xffffffff) <= (i_14_
							     ^ 0xffffffff)
			&& i_13_ >= Class98_Sub10_Sub38.anInt5753
			&& (i_13_ ^ 0xffffffff) >= (Class218.anInt1635
						    ^ 0xffffffff)
			&& Class98_Sub10_Sub38.anInt5753 <= i_10_
			&& (i_10_ ^ 0xffffffff) >= (Class218.anInt1635
						    ^ 0xffffffff)
			&& i_9_ >= Class98_Sub10_Sub38.anInt5753
			&& Class218.anInt1635 >= i_9_
			&& ((Class98_Sub10_Sub38.anInt5753 ^ 0xffffffff)
			    >= (i_11_ ^ 0xffffffff))
