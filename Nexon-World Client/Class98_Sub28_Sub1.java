...
final class Class98_Sub28_Sub1 extends Class98_Sub28
{
	...
	try {
	    ...
	    if (((ha_Sub1) ((Class98_Sub28) this).aHa_Sub1_4079).aBoolean4460
		&& (((ha_Sub1) ((Class98_Sub28) this).aHa_Sub1_4079)
		    .aBoolean4447)
		&& (((ha_Sub1) ((Class98_Sub28) this).aHa_Sub1_4079)
		    .aBoolean4383)) {
		aClass288_5802
		    = new Class288(((Class98_Sub28) this).aHa_Sub1_4079);
		aClass42_Sub1_5804
		    = new Class42_Sub1(((Class98_Sub28) this).aHa_Sub1_4079,
				       3553, 34842, 256, 256);
		...
		((Class98_Sub28) this).aHa_Sub1_4079
		    .method1898(true, aClass288_5802);
		...
		aClass336_5813
		    = (Class177.method2584
		       (((Class98_Sub28) this).aHa_Sub1_4079,
			(new Class345[]
			 { Class246_Sub3_Sub1_Sub1.method2996
			   (35632, ((Class98_Sub28) this).aHa_Sub1_4079, false,
    ...
    public static void method1308(byte i) {
	do {
	    try {
    ...
    final boolean method1309(byte i) {
	try {
	    if (i != 41)
		return false;
	    if (!((ha_Sub1) ((Class98_Sub28) this).aHa_Sub1_4079).aBoolean4460
    ...
    Class98_Sub28_Sub1(ha_Sub1 var_ha_Sub1) {
	super(var_ha_Sub1);
    }
    
    final boolean method1298(int i) {
	try {
	    if (i <= 10)
		method1298(6);
    ...
    final int method1299(boolean bool) {
	try {
	    if (bool != false)
    ...
    static final byte[] method1310(boolean bool, Object object,
				   boolean bool_2_) {
	try {
	    if (object == null)
		return null;
    ...
    final void method1295(int i, int i_3_, boolean bool) {
	try {
	    anInt5806 = i;
	    anInt5801 = i_3_;
		...
		if (anInt5807 != i_4_
			...
			for (int i_6_ = 0;
			     ((aClass42_Sub1Array5812.length ^ 0xffffffff)
			      < (i_6_ ^ 0xffffffff));
			     i_6_++)
			...
			if (aClass288_5809 == null)
			    aClass288_5809
				= new Class288(((Class98_Sub28) this)
					       .aHa_Sub1_4079);
			...
			i_9_ = 0;
			while (i_7_ > 256 || (i_8_ ^ 0xffffffff) < -257) {
			    aClass42_Sub1Array5812[i_9_++]
				= new Class42_Sub1((((Class98_Sub28) this)
						    .aHa_Sub1_4079),
    ...
    final void method1302(Class42_Sub1 class42_sub1, int i, byte i_10_,
			  Class42_Sub1 class42_sub1_11_) {
	try {
		...
		OpenGL.glUniform3fARB(OpenGL.glGetUniformLocationARB(l,
								     "params"),
				      Class246_Sub3_Sub3_Sub1.aFloat6257, 0.0F,
				      0.0F);
		OpenGL.glBegin(7);
		OpenGL.glTexCoord2f(0.0F, 0.0F);
		OpenGL.glVertex2i(0, 0);
		OpenGL.glTexCoord2f((float) anInt5801, 0.0F);
		OpenGL.glVertex2i(1, 0);
		OpenGL.glTexCoord2f((float) anInt5801, (float) anInt5806);
		OpenGL.glVertex2i(1, 1);
		OpenGL.glTexCoord2f(0.0F, (float) anInt5806);
		OpenGL.glVertex2i(0, 1);
		OpenGL.glEnd();
	    } else {
		((Class98_Sub28) this).aHa_Sub1_4079
		    .method1898(true, aClass288_5809);
		...
		while (i_12_ > 256 || i_13_ > 256) {
			...
			((Class98_Sub28) this).aHa_Sub1_4079
			    .method1863(i_10_ + 65, class42_sub1_11_);
			OpenGL.glBegin(7);
			OpenGL.glTexCoord2f(0.0F, 0.0F);
			OpenGL.glVertex2i(0, 0);
			OpenGL.glTexCoord2f((float) anInt5801, 0.0F);
			OpenGL.glVertex2i(1, 0);
			OpenGL.glTexCoord2f((float) anInt5801,
					    (float) anInt5806);
			OpenGL.glVertex2i(1, 1);
			OpenGL.glTexCoord2f(0.0F, (float) anInt5806);
			OpenGL.glVertex2i(0, 1);
			...
			((Class98_Sub28) this).aHa_Sub1_4079
			    .method1863(1, aClass42_Sub1Array5812[i_14_ + -1]);
			OpenGL.glBegin(7);
			OpenGL.glTexCoord2f(0.0F, 0.0F);
			OpenGL.glVertex2i(0, 0);
		...
		((Class98_Sub28) this).aHa_Sub1_4079.method1907(aClass288_5809,
								-1);
		((Class98_Sub28) this).aHa_Sub1_4079
		    .method1863(1, aClass42_Sub1Array5812[-1 + i_14_]);
		((Class98_Sub28) this).aHa_Sub1_4079
		    .method1898(true, aClass288_5802);
	    ...
	    ((Class98_Sub28) this).aHa_Sub1_4079
		.method1863(1, aClass42_Sub1_5804);
	    ...
	    aClass288_5802.method3404(i_10_ + 64, 0);
	    ((Class98_Sub28) this).aHa_Sub1_4079
		.method1863(i_10_ ^ ~0x3e, aClass42_Sub1_5808);
	    OpenGL.glUniform3fARB(OpenGL.glGetUniformLocationARB(l, "step"),
	    ...
	    OpenGL.glUniform1iARB(OpenGL.glGetUniformLocationARB(l_15_,
								 "sceneTex"),
				  0);
	    OpenGL.glUniform1iARB(OpenGL.glGetUniformLocationARB(l_15_,
								 "bloomTex"),
				  1);
	    OpenGL.glUniform3fARB(OpenGL.glGetUniformLocationARB(l_15_,
								 "params"),
				  Class313.aFloat2680, Class177.aFloat1378,
				  0.0F);
	    ((Class98_Sub28) this).aHa_Sub1_4079.method1845(1, 847872872);
	    ((Class98_Sub28) this).aHa_Sub1_4079
		.method1863(1, aClass42_Sub1_5804);
