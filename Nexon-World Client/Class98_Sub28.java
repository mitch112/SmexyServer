...
abstract class Class98_Sub28 extends Class98
{
    ...
    static final void method1296(byte i) {
	try {
	    int i_1_ = -92 % ((i - -52) / 32);
	    Class142.aClass79_1158.method794(106);
	} catch (RuntimeException runtimeexception) {
	    throw Class64_Sub27.method667(runtimeexception, "lb.K(" + i + ')');
	}
    }
    ...
    final boolean method1301(int i) {
	try {
	    if (i > -5)
		return false;
	    return false;
	} catch (RuntimeException runtimeexception) {
	    throw Class64_Sub27.method667(runtimeexception, "lb.M(" + i + ')');
	}
    }
    ...
    static final String method1305(int i, long l) {
	try {
		...
		i_5_++;
	    StringBuffer stringbuffer = new StringBuffer(i_5_);
	    if (i > -42)
		method1307(16, -80, -112, 57);
	    while (l != 0L) {
		long l_7_ = l;
		l /= 37L;
		stringbuffer.append(Exception_Sub1.aCharArray45
				    [(int) (-(37L * l) + l_7_)]);
	    }
    ...
    static final int method1306(byte i) {
	try {
	    boolean bool = false;
	    boolean bool_8_ = false;
	    boolean bool_9_ = false;
	    if (((Class88) Class98_Sub43_Sub2.aClass88_5907).aBoolean682
		&& !((Class88) Class98_Sub43_Sub2.aClass88_5907).aBoolean675) {
		bool = true;
		if ((((Class98_Sub35) Exception_Sub1.aClass98_Sub35_47)
		     .anInt4129) < 512
		    && (((Class98_Sub35) Exception_Sub1.aClass98_Sub35_47)
			.anInt4129) != 0)
		    bool = false;
		...
		if (bool_9_) {
			...
			if (((Class98_Sub27) Class98_Sub9.aClass98_Sub27_3856)
				.aClass64_Sub8_4042.method583((byte) 127)
			    == 3) {
			    Class62 class62 = Class265.aHa1974.method1799();
			    long l = (0xffffffffffffL
				      & ((Class62) class62).aLong485);
			    int i_13_ = ((Class62) class62).anInt484;
			    if ((i_13_ ^ 0xffffffff) != -4319) {
				if ((i_13_ ^ 0xffffffff) != -4099)
				    break;
			    } else {
				bool_8_ = bool_8_ & ((l ^ 0xffffffffffffffffL)
						     <= -64425238955L);
				break;
			    }
	    ...
	    throw Class64_Sub27.method667(runtimeexception, "lb.O(" + i + ')');
	}
    }
	...
	try {
	    ...
	    for (Class98_Sub47 class98_sub47
		     = ((Class98_Sub47)
			Class278.aClass148_2065.method2418(i_14_ ^ 0x21));
		 class98_sub47 != null;
		 class98_sub47 = ((Class98_Sub47)
				  Class278.aClass148_2065.method2417(88))) {
		if (i == ((Class98_Sub47) class98_sub47).anInt4268) {
		    ...
		    int i_23_ = (i_21_ + Class278.anInt2075 << -1106336498
				 | Class278.anInt2078 + i_22_);
		    int i_24_ = ((i_20_ + -i_22_) * (i_20_ + -i_22_)
				 + (-i_21_ + i_19_) * (i_19_ - i_21_));
