...
public class OpenGL
{
	...
	(int i, int i_13_, int i_14_, int i_15_, byte[] is, int i_16_);
    
    public final native void releasePbuffer(long l);
    
    public static final native void glPolygonMode(int i, int i_17_);
    
    public static final native void glProgramRawARB(int i, int i_18_,
						    byte[] is);
    ...
    public static final native void glNormal3f(float f, float f_36_,
					       float f_37_);
	...
	(int i, int i_40_, int i_41_, int i_42_, int i_43_, int i_44_,
	 int i_45_, int i_46_);
    ...
    public static final native void glTexParameteri(int i, int i_63_,
						    int i_64_);
    
    public static final native void glTexImage2Df
	(int i, int i_65_, int i_66_, int i_67_, int i_68_, int i_69_,
	 int i_70_, int i_71_, float[] fs, int i_72_);
	...
	(long l, int i, int[] is, int i_78_, byte[] is_79_, int i_80_);
    
    public static final native void glScalef(float f, float f_81_,
					     float f_82_);
	...
	(int i, int i_84_, int i_85_, int i_86_, int[] is, int i_87_);
	...
	(int i, int i_90_, boolean bool, float[] fs, int i_91_);
	...
	(int i, int i_100_, boolean bool, float[] fs, int i_101_);
    ...
    public static final native void glOrtho(double d, double d_119_,
					    double d_120_, double d_121_,
					    double d_122_, double d_123_);
    
    public static final native void glFogf(int i, float f);
    
    public static final native void glReadPixelsi
	(int i, int i_124_, int i_125_, int i_126_, int i_127_, int i_128_,
	 int[] is, int i_129_);
	...
	(int i, int i_138_, int i_139_, int i_140_, int i_141_, int i_142_,
	 int i_143_, int i_144_, int[] is, int i_145_);
    ...
    public static final native void glColor3ub(byte i, byte i_148_,
					       byte i_149_);
    ...
    public static final native void glGenBuffersARB(int i, int[] is,
						    int i_156_);
	...
	(int i, int i_166_, float[] fs, int i_167_);
    ...
    public static final native void glTexParameterf(int i, int i_174_,
						    float f);
	...
	try {
	    if (a == null) {
		a = new Hashtable();
		String string_175_ = glGetString(7939);
		int i = 0;
		for (;;) {
		    int i_176_ = string_175_.indexOf(' ', i);
		    if ((i_176_ ^ 0xffffffff) == 0)
			break;
		    String string_177_
			= string_175_.substring(i, i_176_).trim();
		    i = 1 + i_176_;
		    if (string_177_.length() != 0)
			a.put(string_177_, string_177_);
		}
		String string_178_ = string_175_.substring(i).trim();
	...
	(int i, int i_179_, int i_180_, int i_181_);
	...
	(int i, int i_183_, int i_184_, int i_185_, int i_186_);
    
    public static final native void glUniform4fARB
	(int i, float f, float f_187_, float f_188_, float f_189_);
    
    public static final native void glNewList(int i, int i_190_);
    
    public static final native void glEnable(int i);
    
    public static final native void glStencilFunc(int i, int i_191_,
						  int i_192_);
	...
	(int i, int i_194_, boolean bool, float[] fs, int i_195_);
    
    public static final native void glTexImage3Dub
	(int i, int i_196_, int i_197_, int i_198_, int i_199_, int i_200_,
	 int i_201_, int i_202_, int i_203_, byte[] is, int i_204_);
    
    public static final native void glColorMask
	(boolean bool, boolean bool_205_, boolean bool_206_,
	 boolean bool_207_);
	...
	(int i, int i_210_, int i_211_, int i_212_, byte[] is, int i_213_);
    
    public static final native void glBlitFramebufferEXT
	(int i, int i_214_, int i_215_, int i_216_, int i_217_, int i_218_,
	 int i_219_, int i_220_, int i_221_, int i_222_);
	...
	try {
	    ...
	    if (attachPeer()) {
		OpenGL opengl_242_ = (OpenGL) b.put(thread, this);
		if (opengl_242_ != null)
		    opengl_242_.c = null;
		c = thread;
		return true;
	...
	(int i, int i_245_, int i_246_, int i_247_, int i_248_, int i_249_,
	 int i_250_, int i_251_, int i_252_);
    
    public static final native void glFrustum(double d, double d_253_,
					      double d_254_, double d_255_,
					      double d_256_, double d_257_);
	...
	(int i, int i_260_, int i_261_, int i_262_, int i_263_, int i_264_,
	 int i_265_, int i_266_, byte[] is, int i_267_);
	...
	(int i, int i_269_, int i_270_, int i_271_, int i_272_, int i_273_,
	...
	(int i, int i_277_, int i_278_, byte[] is, int i_279_);
	...
	(int i, int i_292_, int i_293_, int i_294_, int i_295_, int i_296_,
	 int i_297_, int i_298_, byte[] is, int i_299_);
    
    public static final native void glGetTexImagei
	(int i, int i_300_, int i_301_, int i_302_, int[] is, int i_303_);
    
    public final native void swapBuffers();
    
    public static final native void glFramebufferTexture2DEXT
	(int i, int i_304_, int i_305_, int i_306_, int i_307_);
