...
final class Class93_Sub1_Sub1 extends Class93_Sub1
{
	...
	try {
		...
		if (bool != false)
		    anInt6291 = 95;
		if (i_16_ < Class191.anInt1477 && (i_17_ ^ 0xffffffff) <= -1
		    ...
		    if (i_18_ < 0)
			i_18_ = 0;
		    if ((Class63.anInt493 ^ 0xffffffff)
			>= (i_19_ ^ 0xffffffff))
			i_19_ = -1 + Class63.anInt493;
		    if ((i_17_ ^ 0xffffffff)
			<= (Class191.anInt1477 ^ 0xffffffff))
			i_17_ = Class191.anInt1477 + -1;
		    for (int i_20_ = i_18_; i_20_ <= i_19_; i_20_++) {
			int i_21_
			    = (Class198.method2678((byte) 6,
						   i_20_ + Class268.anInt2007,
						   Class63.anInt493)
			       * Class191.anInt1477);
				...
				= (i_21_
				   + Class198.method2678((byte) 6,
							 i_22_ - -(Class76_Sub8
								   .anInt3780),
							 Class191.anInt1477));
			    Class146_Sub2.anIntArray4873[i_23_]
				= Class230.anInt1732;
			}
		    }
		}
	...
	try {
		...
		&& (i != 3
		    || (Class110.anInt946 ^ 0xffffffff) != (i_26_ ^ 0xffffffff)
		    || (i_27_ ^ 0xffffffff) != (Class112.anInt949
						^ 0xffffffff))) {
		...
		Class98_Sub18.aFrame3950
		    = Class54.method503(0, (byte) 105, i_26_, i_27_, 0,
					Class98_Sub43_Sub2.aClass88_5907);
		if (Class98_Sub18.aFrame3950 != null) {
	    ...
	    if ((i ^ 0xffffffff) == -4 && Class98_Sub18.aFrame3950 == null)
		method909(((Class98_Sub27) Class98_Sub9.aClass98_Sub27_3856)
			      .aClass64_Sub27_4052.method666((byte) 120),
			  i_24_, true, i_25_, -1, -1);
	    else {
		...
		if (Class98_Sub18.aFrame3950 == null) {
			...
			if (Class76_Sub11.anApplet3799 != null)
			    ...
			    container
				= Class246_Sub3_Sub5_Sub2.anApplet_Sub1_6271;
			...
			Class188.anInt1453
			    = (Class284.aFrame2168.getSize().width
			       + (-insets.left + -insets.right));
			Class123_Sub1.anInt4744
			    = (Class284.aFrame2168.getSize().height
		...
		if ((i ^ 0xffffffff) != -2)
			...
			= ((Class188.anInt1453 + -Class98_Sub17_Sub1.anInt5782)
			   / 2);
		}
		...
		if (!bool) {
			...
			Class265.aHa1974.method1782(Class42_Sub3.aCanvas5361,
			...
			Insets insets = Class284.aFrame2168.getInsets();
			Class42_Sub3.aCanvas5361.setLocation
			    (insets.left + Class98_Sub46_Sub10.anInt6022,
			     insets.top + Class191.anInt1479);
		    }
		} else
