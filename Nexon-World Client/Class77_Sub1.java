...
final class Class77_Sub1 extends Class77 implements KeyListener, FocusListener
{
    ...
    private Class148 aClass148_3806 = new Class148();
	...
	try {
	    ...
	    if (i_2_ != 0) {
		if (i_2_ >= 0
		    && (i_2_ ^ 0xffffffff) > (Class87.anIntArray667.length
					      ^ 0xffffffff)) {
	...
	do {
	    try {
		aClass148_3802.method2422((byte) 47);
		for (Class98_Sub8 class98_sub8
			 = (Class98_Sub8) aClass148_3806.method2421(6494);
		     class98_sub8 != null;
		     class98_sub8
			 = (Class98_Sub8) aClass148_3806.method2421(6494)) {
		    ((Class98_Sub8) class98_sub8).anInt3266
			= method784((byte) 127);
		    if (((Class98_Sub8) class98_sub8).anInt3268 != 0) {
			if ((((Class98_Sub8) class98_sub8).anInt3268
			     ^ 0xffffffff)
			    == -2) {
			    if (aBooleanArray3808
				[((Class98_Sub8) class98_sub8).anInt3269]) {
				aClass148_3802.method2419(class98_sub8,
							  -20911);
				aBooleanArray3808
				    [((Class98_Sub8) class98_sub8).anInt3269]
				    = false;
			    }
			} else if (((Class98_Sub8) class98_sub8).anInt3268
				   == -1) {
			    for (int i_4_ = 0; (i_4_ ^ 0xffffffff) > -113;
				 i_4_++) {
				if (aBooleanArray3808[i_4_]) {
				    Class98_Sub8 class98_sub8_5_
					= new Class98_Sub8();
				    ((Class98_Sub8) class98_sub8_5_).anInt3266
					= (((Class98_Sub8) class98_sub8)
					   .anInt3266);
				    ((Class98_Sub8) class98_sub8_5_).anInt3269
					= i_4_;
				    ((Class98_Sub8) class98_sub8_5_).aLong3267
					= (((Class98_Sub8) class98_sub8)
					   .aLong3267);
				    ((Class98_Sub8) class98_sub8_5_).anInt3268
					= 1;
				    ((Class98_Sub8) class98_sub8_5_).aChar3265
					= '\0';
			...
			if (!aBooleanArray3808
			    ...
			    ((Class98_Sub8) class98_sub8_6_).aLong3267
				= ((Class98_Sub8) class98_sub8).aLong3267;
			    ((Class98_Sub8) class98_sub8_6_).anInt3266
				= ((Class98_Sub8) class98_sub8).anInt3266;
			    ((Class98_Sub8) class98_sub8_6_).anInt3268 = 0;
			    ((Class98_Sub8) class98_sub8_6_).aChar3265 = '\0';
			    ((Class98_Sub8) class98_sub8_6_).anInt3269
				= ((Class98_Sub8) class98_sub8).anInt3269;
			    aClass148_3802.method2419(class98_sub8_6_, -20911);
			    aBooleanArray3808[(((Class98_Sub8) class98_sub8)
					       .anInt3269)]
				= true;
			}
	...
	try {
	    for (Class98_Sub33 class98_sub33
		     = (Class98_Sub33) Class191.aClass148_1478.method2418(32);
		 class98_sub33 != null;
		 class98_sub33 = ((Class98_Sub33)
				  Class191.aClass148_1478.method2417(94))) {
		if (((Class98_Sub33) class98_sub33).aBoolean4124)
		    class98_sub33.method942(79);
		else {
		    ((Class98_Sub33) class98_sub33).aBoolean4123 = true;
		    if (((Class98_Sub33) class98_sub33).anInt4112 >= 0
			&& ((Class98_Sub33) class98_sub33).anInt4113 >= 0
			&& (((Class98_Sub33) class98_sub33).anInt4112
			    ^ 0xffffffff) > (Class165.anInt1276 ^ 0xffffffff)
			&& ((((Class98_Sub33) class98_sub33).anInt4113
			     ^ 0xffffffff)
			    > (Class98_Sub10_Sub7.anInt5572 ^ 0xffffffff)))
			Class98_Sub46_Sub9.method1558((byte) 109,
						      class98_sub33);
		}
	    }
	    for (Class98_Sub33 class98_sub33
		     = ((Class98_Sub33)
			Class98_Sub11.aClass148_3866.method2418(32));
		 class98_sub33 != null;
		 class98_sub33 = (Class98_Sub33) Class98_Sub11
						     .aClass148_3866
						     .method2417(98)) {
		if (!((Class98_Sub33) class98_sub33).aBoolean4124)
		    ((Class98_Sub33) class98_sub33).aBoolean4123 = true;
    ...
    final boolean method779(int i, int i_10_) {
	try {
