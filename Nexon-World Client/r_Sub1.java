...
final class r_Sub1 extends r
{
	...
	try {
		...
		return false;
	    if (((Class98_Sub46_Sub8)
		 Class98_Sub46_Sub19.aClass98_Sub46_Sub8_6066).anInt5990
		>= 2000)
		((Class98_Sub46_Sub8)
		 Class98_Sub46_Sub19.aClass98_Sub46_Sub8_6066).anInt5990
		    -= 2000;
	...
	try {
	    ...
	    while ((((r_Sub1) this).aByteArray6325.length + -1 ^ 0xffffffff)
		   < (i_5_ ^ 0xffffffff))
		((r_Sub1) this).aByteArray6325[++i_5_] = (byte) 0;
	} catch (RuntimeException runtimeexception) {
	...
	try {
	    if (i_8_ > -114)
		return true;
	    if ((((r_Sub1) this).aByteArray6325.length ^ 0xffffffff)
		> (i * i_9_ ^ 0xffffffff))
		return false;
	    return true;
	} catch (RuntimeException runtimeexception) {
	...
	try {
		...
		if (i_13_ > i_14_) {
			...
			while (--i_14_ >= 0) {
			    Class261.method3210((byte) -104,
						((r_Sub1) this).aByteArray6325,
						0, i_12_ >> 2088693072, i,
						i_16_ >> -1493619120);
			    i += ((r_Sub1) this).anInt6323;
			    i_16_ += i_20_;
			    i_12_ += i_18_;
		...
		if (i_13_ != i_14_ && i_19_ > i_18_
		    || i_13_ == i_14_ && i_20_ < i_18_) {
		    i -= i_13_;
		    i_13_ -= i_14_;
		    i_14_ = ((r_Sub1) this).anInt6323 * i_14_;
		    while ((--i_13_ ^ 0xffffffff) <= -1) {
			Class261.method3210((byte) -104,
					    ((r_Sub1) this).aByteArray6325, 0,
					    i_11_ >> 704910512, i_14_,
					    i_12_ >> 114452112);
			i_12_ += i_18_;
