...
final class Class74
{
    ...
    private Class215 aClass215_549 = new Class215();
    private int anInt550;
    static boolean[][] aBooleanArrayArray551;
    
    final void method722(boolean bool) {
	try {
	    if (bool == true) {
    ...
    private final void method723(int i, Interface20 interface20, Object object,
				 boolean bool) {
	try {
	    ...
	    anInt550 -= i;
	    while (anInt550 < 0) {
		Class98_Sub46_Sub20 class98_sub46_sub20
		    = ((Class98_Sub46_Sub20)
		       aClass215_549.method2789(-16711936));
		method728(class98_sub46_sub20, (byte) -100);
	    }
	    Class98_Sub46_Sub20_Sub2 class98_sub46_sub20_sub2
		= new Class98_Sub46_Sub20_Sub2(interface20, object, i);
	...
	try {
		...
		for (Class98_Sub46_Sub20 class98_sub46_sub20
			 = (Class98_Sub46_Sub20) aClass215_549.method2792(-1);
		     class98_sub46_sub20 != null;
		     class98_sub46_sub20
			 = (Class98_Sub46_Sub20) aClass215_549.method2787(0)) {
		    ...
		    } else if (++((Class98_Sub46) class98_sub46_sub20)
				     .aLong4259
			       > (long) i_0_) {
			Class98_Sub46_Sub20 class98_sub46_sub20_1_
			    = Class39_Sub1.aClass277_3590
	...
	do {
		...
		for (Class98_Sub46_Sub20 class98_sub46_sub20
		     ...
		     class98_sub46_sub20
			 = ((Class98_Sub46_Sub20)
			    aClass215_549.method2787(i + -13937))) {
    ...
    public static void method727(byte i) {
	do {
	    try {
    ...
    private final void method728(Class98_Sub46_Sub20 class98_sub46_sub20,
				 byte i) {
	do {
	    try {
		if (class98_sub46_sub20 != null) {
		    ...
		    class98_sub46_sub20.method1524((byte) -90);
		    anInt550 += (((Class98_Sub46_Sub20) class98_sub46_sub20)
				 .anInt6072);
		}
		if (i == -100)
		    break;
    ...
    final void method729(Object object, Interface20 interface20,
			 boolean bool) {
	try {
    ...
    private final void method731(Interface20 interface20, boolean bool) {
	try {
	    if (bool != false)
		method728(null, (byte) -125);
	    long l = interface20.method69(!bool);
	    for (Class98_Sub46_Sub20 class98_sub46_sub20
		     = (Class98_Sub46_Sub20) aClass377_545.method3990(l, -1);
		 class98_sub46_sub20 != null;
		 class98_sub46_sub20
		     = (Class98_Sub46_Sub20) aClass377_545.method3993(122)) {
		if (((Class98_Sub46_Sub20) class98_sub46_sub20)
			.anInterface20_6071.method68(22000, interface20)) {
		    method728(class98_sub46_sub20, (byte) -100);
		    break;
		}
	    }
    ...
    final Object method732(Interface20 interface20, int i) {
	try {
	    if (i != 0)
		return null;
	    ...
	    for (Class98_Sub46_Sub20 class98_sub46_sub20
		     = ((Class98_Sub46_Sub20)
			aClass377_545.method3990(l, i ^ 0xffffffff));
		 class98_sub46_sub20 != null;
		 class98_sub46_sub20
		     = (Class98_Sub46_Sub20) aClass377_545.method3993(-123)) {
		if (((Class98_Sub46_Sub20) class98_sub46_sub20)
			.anInterface20_6071.method68(22000, interface20)) {
			...
			if (class98_sub46_sub20.method1638(896)) {
			    ...
			    aClass215_549.method2785(class98_sub46_sub20_sub2,
						     i + -68);
			    ((Class98_Sub46) class98_sub46_sub20_sub2)
				.aLong4259
				= 0L;
			    ...
			    ((Class98_Sub46) class98_sub46_sub20).aLong4259
				= 0L;
			}
			return object;
		    }
	...
	try {
	    ...
	    anInt548 = i;
	    int i_3_;
	    for (i_3_ = 1; (i_3_ + i_3_ ^ 0xffffffff) > (i ^ 0xffffffff);
		 i_3_ += i_3_) {
		/* empty */
	    }
    ...
    static final void method733(long l, int i) {
	do {
	    try {
		try {
		    Thread.sleep(l);
