...
class Class93 implements Interface21
{
    ...
    static final void method900(int i, byte[][] is,
				Class305_Sub1 class305_sub1) {
	do {
	    try {
		int[] is_0_ = { -1, 0, 0, 0, 0 };
		int i_1_ = 0;
		if (i != 11948)
		    aBoolean3503 = false;
		for (/**/; i_1_ < ((Class305) class305_sub1).anInt2547;
		     i_1_++) {
		    Class128.method2224(22696);
		    for (int i_2_ = 0; i_2_ < Class165.anInt1276 >> 2130796515;
			 i_2_++) {
			for (int i_3_ = 0;
			     ((Class98_Sub10_Sub7.anInt5572 >> 2020537603
			       ^ 0xffffffff)
			      < (i_3_ ^ 0xffffffff));
			     i_3_++) {
			    int i_4_ = (Class170.anIntArrayArrayArray1311[i_1_]
					[i_2_][i_3_]);
			    if (i_4_ != -1) {
				...
				if (!((Class305) class305_sub1).aBoolean2544
				    ...
				    int i_9_
					= (i_7_ / 8 << -1183468824) + i_8_ / 8;
				    for (int i_10_ = 0;
					 (Class121.anIntArray1006.length
					  > i_10_);
					 i_10_++) {
					if ((Class121.anIntArray1006[i_10_]
					     == i_9_)
					    && is[i_10_] != null) {
					    Class98_Sub22 class98_sub22
						= new Class98_Sub22(is[i_10_]);
					    class305_sub1.method3575
						(i_8_, i_3_ * 8, class98_sub22,
						 i_6_, i_5_, 8 * i_2_,
						 i + -11948, i_7_,
						 Class167.aClass243Array1281,
						 i_1_);
					    class305_sub1.method3586
						(i_7_, i_8_,
						 ((is_0_[0] ^ 0xffffffff) != 0
						  ? null : is_0_),
						 i_2_ * 8, 8 * i_3_,
						 class98_sub22,
						 Class265.aHa1974, i_6_, true,
						 i_5_, i_1_);
					    break;
					}
				    }
		...
		for (int i_11_ = 0;
		     ((Class305) class305_sub1).anInt2547 > i_11_; i_11_++) {
		    Class128.method2224(22696);
		    for (int i_12_ = 0;
			 ((Class165.anInt1276 >> -1820522237 ^ 0xffffffff)
			  < (i_12_ ^ 0xffffffff));
			 i_12_++) {
			for (int i_13_ = 0;
			     ((Class98_Sub10_Sub7.anInt5572 >> 101337859
			       ^ 0xffffffff)
			      < (i_13_ ^ 0xffffffff));
			     i_13_++) {
			    int i_14_ = (Class170.anIntArrayArrayArray1311
					 [i_11_][i_12_][i_13_]);
		...
		if ((is_0_[0] ^ 0xffffffff) == 0)
		    break;
		s_Sub1.aClass346_5202
		    = Class373_Sub2.aClass59_5470.method528(0, is_0_[0],
							    is_0_[2], is_0_[1],
							    (Class101
							     .aClass115_857),
							    is_0_[3]);
