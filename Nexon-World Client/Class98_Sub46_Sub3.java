...
final class Class98_Sub46_Sub3 extends Class98_Sub46
{
	...
	try {
	    ((Class98_Sub46_Sub3) this).aClass246_Sub3_Sub4_Sub3_5954
		= class246_sub3_sub4_sub3;
	} catch (RuntimeException runtimeexception) {
	    throw Class64_Sub27.method667(runtimeexception,
					  ("bv.<init>("
	...
	do {
		...
		int i_2_
		    = (Class98_Sub46_Sub2_Sub2.method1538(Class43.anInt377,
							  i_1_, i_0_, 24111)
		       - Class308.anInt2580);
		do {
		    if ((Class263.anInt1967 ^ 0xffffffff) <= -101) {
			Class134.anInt3461
			    = 256 + 512 * Class98_Sub10_Sub21.anInt5643;
			Class98_Sub46_Sub10.anInt6020
			    = Class363.anInt3098 * 512 + 256;
			Class79.anInt601
			...
			if ((Class98_Sub46_Sub10.anInt6020 ^ 0xffffffff)
			    < (i_0_ ^ 0xffffffff))
			    Class98_Sub46_Sub10.anInt6020 = i_0_;
		    }
			...
			Class98_Sub46_Sub10.anInt6020
			    -= (Class98_Sub46_Sub2_Sub2.anInt6300
				+ ((-i_0_ + Class98_Sub46_Sub10.anInt6020)
				   * Class263.anInt1967 / 1000));
			if (Class98_Sub46_Sub10.anInt6020 < i_0_)
			    Class98_Sub46_Sub10.anInt6020 = i_0_;
		    }
		    if ((Class79.anInt601 ^ 0xffffffff)
			> (i_2_ ^ 0xffffffff)) {
			Class79.anInt601
			    += ((-Class79.anInt601 + i_2_) * Class263.anInt1967
				/ 1000) + Class98_Sub46_Sub2_Sub2.anInt6300;
			...
			Class134.anInt3461
				...
				+ Class98_Sub46_Sub2_Sub2.anInt6300);
			if ((Class134.anInt3461 ^ 0xffffffff)
			    < (i_1_ ^ 0xffffffff))
			    Class134.anInt3461 = i_1_;
		    }
		    if ((Class79.anInt601 ^ 0xffffffff)
			< (i_2_ ^ 0xffffffff)) {
			Class79.anInt601 -= (Class98_Sub46_Sub2_Sub2.anInt6300
					     - -((Class79.anInt601 - i_2_)
						 * Class263.anInt1967 / 1000));
		...
		i_2_ = (Class98_Sub46_Sub2_Sub2.method1538(Class43.anInt377,
							   i_1_, i_0_, 24111)
			- Class303.anInt2530);
		int i_3_ = -Class98_Sub46_Sub10.anInt6020 + i_0_;
		int i_4_ = -Class79.anInt601 + i_2_;
		int i_5_ = -Class134.anInt3461 + i_1_;
		int i_6_
		    = (int) Math.sqrt((double) (i_3_ * i_3_ - -(i_5_ * i_5_)));
		int i_7_
		    = 0x3fff & (int) (Math.atan2((double) i_4_, (double) i_6_)
				      * 2607.5945876176133);
		int i_8_ = ((int) (-2607.5945876176133
		...
		if (Class246_Sub3_Sub4_Sub2.anInt6357 < i_7_) {
			...
			+= ((i_7_ - Class246_Sub3_Sub4_Sub2.anInt6357
			     >> -1117924989) * Class98_Sub4.anInt3828 / 1000
			    + Class98_Sub41.anInt4202) << -1739945821;
		    if (Class246_Sub3_Sub4_Sub2.anInt6357 > i_7_)
			Class246_Sub3_Sub4_Sub2.anInt6357 = i_7_;
		}
		if ((i_7_ ^ 0xffffffff)
		    > (Class246_Sub3_Sub4_Sub2.anInt6357 ^ 0xffffffff)) {
		    Class246_Sub3_Sub4_Sub2.anInt6357
			-= (Class98_Sub41.anInt4202
			    + (Class98_Sub4.anInt3828
			       * (-i_7_ + Class246_Sub3_Sub4_Sub2.anInt6357
				  >> 1278679235)
			       / 1000)) << -1425824541;
		...
		if ((i_9_ ^ 0xffffffff) < -1) {
		    Class186.anInt3424
			+= (Class98_Sub4.anInt3828 * i_9_ / 1000
			    + Class98_Sub41.anInt4202) << 1507566883;
		    Class186.anInt3424 &= 0x3fff;
		}
		if (i_9_ < 0) {
		    Class186.anInt3424
			-= (Class98_Sub4.anInt3828 * -i_9_ / 1000
			    + Class98_Sub41.anInt4202) << 1406205123;
		    Class186.anInt3424 &= 0x3fff;
		}
