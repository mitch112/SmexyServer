...
final class Class98_Sub10_Sub16 extends Class98_Sub10
{
	...
	try {
	    ...
	    Class146 class146
		= ((Class146)
		   Class246_Sub4_Sub1.aClass79_6170.method802(-126, l));
	    int i_5_ = 2055;
	    if (class146 == null) {
		Class178 class178
		    = Class98_Sub6.method981(0, -9252,
					     Class76_Sub9.aClass207_3787,
					     i_2_);
		if (class178 == null)
		    return null;
		if ((((Class178) class178).anInt1387 ^ 0xffffffff) > -14)
		    class178.method2592(13746, 2);
		class146 = var_ha.method1790(class178, i_5_,
					     Class98_Sub10_Sub13.anInt5600, 64,
					     768);
	...
	try {
		...
		int[] is_10_ = is_7_[2];
		for (int i_11_ = 0;
		     (i_11_ ^ 0xffffffff) > (Class25.anInt268 ^ 0xffffffff);
		     i_11_++)
		    is[i_11_]
			= (is_8_[i_11_] + (is_9_[i_11_] - -is_10_[i_11_])) / 3;
	    }
	    return is;
	} catch (RuntimeException runtimeexception) {
	    throw Class64_Sub27.method667(runtimeexception,
