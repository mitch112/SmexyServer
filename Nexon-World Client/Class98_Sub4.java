...
final class Class98_Sub4 extends Class98
{
    ...
    static final void method953(int i, int i_0_, boolean bool) {
	try {
		...
		for (Class98_Sub46_Sub9 class98_sub46_sub9
			 = ((Class98_Sub46_Sub9)
			    Class98_Sub18.aClass215_3949.method2792(-1));
		     class98_sub46_sub9 != null;
		     class98_sub46_sub9
			 = ((Class98_Sub46_Sub9)
			    Class98_Sub18.aClass215_3949.method2787(0))) {
		    int i_3_;
		    if ((((Class98_Sub46_Sub9) class98_sub46_sub9).anInt6001
			 ^ 0xffffffff)
			!= -2)
			i_3_ = Class98_Sub10_Sub25
				   .method1079(class98_sub46_sub9, 21);
		    else
			i_3_ = Class222.method2824((byte) 81,
						   ((Class98_Sub46_Sub8)
						    (((Class98_Sub46)
						      (((Class215)
							(((Class98_Sub46_Sub9)
		...
		for (Class98_Sub46_Sub8 class98_sub46_sub8
		     ...
		     class98_sub46_sub8
			 = ((Class98_Sub46_Sub8)
			    Class33.aClass148_315.method2417(119))) {
		    int i_4_
			= Class222.method2824((byte) 75, class98_sub46_sub8);
		    if ((i_1_ ^ 0xffffffff) > (i_4_ ^ 0xffffffff))
			i_1_ = i_4_;
		}
		i_1_ += 8;
		Class15.anInt172
		    = Class359.anInt3058 * 16 + (Class98_Sub5_Sub3.aBoolean5539
						 ? 26 : 22);
		i_2_ = 21 + Class359.anInt3058 * 16;
	    }
	    int i_5_ = i_0_ + -(i_1_ / 2);
	    if ((Class39_Sub1.anInt3593 ^ 0xffffffff)
		> (i_5_ - -i_1_ ^ 0xffffffff))
