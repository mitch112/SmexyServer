...
final class InputStream_Sub2 extends InputStream
{
    ...
    static final aa_Sub3 method123(int i, int[] is, ha_Sub1 var_ha_Sub1,
				   int i_0_, int[] is_1_, byte i_2_) {
	try {
	    if (i_2_ != 111)
		anInt29 = -5;
		...
		for (int i_6_ = 0;
		     (i_6_ ^ 0xffffffff) > (is_1_[i_4_] ^ 0xffffffff); i_6_++)
		    is_3_[i_5_++] = (byte) -1;
	    }
    ...
    static final void method125(int i, int i_8_, int i_9_, int i_10_,
				int i_11_, int i_12_) {
	try {
	    int i_13_ = i + -i_11_;
	    if (i_12_ != 21597)
		...
		if (i_14_ != 0)
		    Class98_Sub50.method1671(i_11_, (byte) 0, i_10_, i_9_,
					     i_8_);
		return;
	    }
		...
		i_17_ = ((-i_16_ + Class98_Sub10_Sub38.anInt5753 << -561169876)
			 / i_15_);
	    } else if ((Class218.anInt1635 ^ 0xffffffff)
		       > (i_18_ ^ 0xffffffff)) {
		i_17_ = (-i_16_ + Class218.anInt1635 << -895871700) / i_15_;
		i_18_ = Class218.anInt1635;
	    }
	    if ((Class98_Sub10_Sub38.anInt5753 ^ 0xffffffff)
		>= (i_19_ ^ 0xffffffff)) {
		...
		i_20_ = ((-i_16_ + Class98_Sub10_Sub38.anInt5753 << 865861260)
			 / i_15_);
	    }
