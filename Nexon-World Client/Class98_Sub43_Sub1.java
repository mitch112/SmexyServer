...
final class Class98_Sub43_Sub1 extends Class98_Sub43
{
	...
	do {
		...
		if (Class98_Sub10_Sub1.aClass75Array5542 == null) {
		    Class98_Sub10_Sub1.aClass75Array5542
			= Class75.method735(-127);
		    Class45.aClass75_381
			= Class98_Sub10_Sub1.aClass75Array5542[0];
		...
		if (i == -16798) {
			...
			Class107.aString912
			    = ((Class75) Class45.aClass75_381)
				  .aClass309_560
				  .method3615(Class374.anInt3159, (byte) 25);
			if (((Class75) Class45.aClass75_381).aBoolean553)
			    Class195.anInt1506
				= ((-((Class75) Class45.aClass75_381).anInt552
				    + (((Class75) Class45.aClass75_381)
				       .anInt557)) * i_0_ / 100
				   + (((Class75) Class45.aClass75_381)
				      .anInt552));
			if (((Class75) Class45.aClass75_381).aBoolean554)
			...
			Class107.aString912
			    = ((Class75) class75).aClass309_555
				  .method3615(Class374.anInt3159, (byte) 25);
			Class195.anInt1506 = ((Class75) class75).anInt557;
			if (((Class75) Class45.aClass75_381).aBoolean554)
			    Class107.aString912
				+= ((Class75) class75).anInt557 + "%";
			if (((Class75) Class45.aClass75_381).aBoolean553
			    || ((Class75) class75).aBoolean553)
			...
			break;
		    for (int i_1_ = 1 + Class21_Sub3.anInt5390;
			 ((Class39_Sub1.anInterface10Array3592.length
			   ^ 0xffffffff)
			  < (i_1_ ^ 0xffffffff));
			 i_1_++) {
			if ((Class39_Sub1.anInterface10Array3592[i_1_]
			    ...
			    Class140.aClass47_3241.method444
				((byte) -74,
				 Class39_Sub1.anInterface10Array3592[i_1_]);
			    Class21_Sub3.anInt5390++;
			    if (((Class21_Sub3.anInt5390 ^ 0xffffffff)
				 <= ((Class39_Sub1
				      .anInterface10Array3592).length + -1
				     ^ 0xffffffff))
				&& (Class39_Sub1.anInterface10Array3592.length
				    ^ 0xffffffff) < -2)
				Class21_Sub3.anInt5390
				    = (Class3.aClass282_76.method3337(1) ? 0
				       : -1);
			}
		    }
		}
	...
	do {
	    try {
		if (bool == false) {
		    if ((((Class98_Sub43) this).anInt4240 ^ 0xffffffff)
			<= -4) {
			if ((aVorbisBlock5898.synthesis(oggpacket)
			     ^ 0xffffffff)
			    == -1)
			    aDSPState5901.blockIn(aVorbisBlock5898);
			float[][] fs
			    = aDSPState5901.pcmOut(aVorbisInfo5905.channels);
			aDouble5899 = aDSPState5901.granuleTime();
			if (aDouble5899 == -1.0)
			    aDouble5899
				= (double) ((float) anInt5903
					    / (float) aVorbisInfo5905.rate);
			aDSPState5901.read(fs[0].length);
			anInt5903 += fs[0].length;
			Class98_Sub46_Sub15 class98_sub46_sub15
			    = aClass98_Sub31_Sub4_5902
				  .method1385(aDouble5899, fs[0].length, -99);
			Class151_Sub3.method2455(fs, (byte) -78,
						 (((Class98_Sub46_Sub15)
						   class98_sub46_sub15)
						  .aShortArrayArray6040));
			for (int i = 0; i < aVorbisInfo5905.channels; i++)
			    ((Class98_Sub46_Sub15) class98_sub46_sub15)
				.aShortArrayArray6040[i]
				= (aClass314_5900.method3641
				   (6, (((Class98_Sub46_Sub15)
					 class98_sub46_sub15)
					.aShortArrayArray6040[i])));
			aClass98_Sub31_Sub4_5902
			    .method1380((byte) 111, class98_sub46_sub15);
		    } else {
			int i = aVorbisInfo5905.headerIn(aVorbisComment5904,
							 oggpacket);
			if ((i ^ 0xffffffff) > -1)
			...
			if ((aVorbisInfo5905.channels ^ 0xffffffff) < -3
			    ...
			    throw new RuntimeException
				      (String
					   .valueOf(aVorbisInfo5905.channels));
			...
			aClass98_Sub31_Sub4_5902
			    = new Class98_Sub31_Sub4(aVorbisInfo5905.channels);
		    }
		}
	    } catch (RuntimeException runtimeexception) {
		throw Class64_Sub27.method667(runtimeexception,
