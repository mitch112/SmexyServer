...
final class Class98_Sub46_Sub13_Sub1 extends Class98_Sub46_Sub13
{
	...
	try {
		...
		return 0;
	    return (((Class98_Sub22) (((Class98_Sub46_Sub13_Sub1) this)
				      .aClass98_Sub22_6305)).anInt3991
		    * 100
		    / (-((Class98_Sub46_Sub13_Sub1) this).aByte6306
		       + (((Class98_Sub22) (((Class98_Sub46_Sub13_Sub1) this)
					    .aClass98_Sub22_6305))
	...
	try {
	    ...
	    if ((((Class98_Sub27) Class98_Sub9.aClass98_Sub27_3856)
		     .aClass64_Sub10_4070.method592((byte) 127)
		 ^ 0xffffffff)
		== -2) {
		i_0_ |= 0x1;
		i_0_ |= 0x10;
	    ...
	    if (((Class98_Sub27) Class98_Sub9.aClass98_Sub27_3856)
		    .aClass64_Sub20_4056.method634((byte) 124)
		== 0)
		i_0_ |= 0x40;
	...
	try {
		...
		|| (((((Class98_Sub22)
		       ((Class98_Sub46_Sub13_Sub1) this).aClass98_Sub22_6305)
		      .aByteArray3992).length
		     - ((Class98_Sub46_Sub13_Sub1) this).aByte6306)
		    > ((Class98_Sub22) (((Class98_Sub46_Sub13_Sub1) this)
					.aClass98_Sub22_6305)).anInt3991))
    ...
    static final void method1594(int i, int i_1_, int i_2_, int i_3_,
				 byte i_4_) {
	try {
		...
		Class332 class332 = (Class76_Sub7.aClass332Array3764
				     [Class98_Sub10_Sub32.anInt5720 / 100]);
		...
		Class332 class332
		    = (Class76_Sub7.aClass332Array3764
		       [4 - -(Class98_Sub10_Sub32.anInt5720 / 100)]);
