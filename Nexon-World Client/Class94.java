...
final class Class94
{
	...
	try {
		...
		if (Class98_Sub46_Sub20_Sub2.aClass218Array6316.length > i
		    && !Class98_Sub46_Sub20_Sub2.aClass218Array6316[i]
			    .method2812(true)) {
		    class246_sub1
			= (Class246_Sub1) Class98_Sub46_Sub20_Sub2
					      .aClass218Array6316[i]
					      .method2810((byte) -39);
		    class246_sub1.method2965((byte) 126);
		    Class1.anIntArray65[i]--;
		} else {
		    class246_sub1 = new Class246_Sub1();
		    ((Class246_Sub1) class246_sub1).aClass246_Sub6Array5067
			= new Class246_Sub6[i];
		    for (int i_3_ = 0; i > i_3_; i_3_++)
			((Class246_Sub1) class246_sub1)
			    .aClass246_Sub6Array5067[i_3_]
			    = new Class246_Sub6();
		}
    ...
    static final void method916(int i, Class207 class207, Class207 class207_4_,
				Class207 class207_5_, Class207 class207_6_) {
	try {
		...
		= (new Class293
		   [Class98_Sub17_Sub1.aClass207_5783.method2752((byte) -11)]
		   []);
	...
	try {
	    if (i > -90)
		return false;
	    if (!(Class195.method2663(i_8_, i_7_, false)
		  | (i_8_ & 0x70000 ^ 0xffffffff) != -1)
    ...
    static final void method919(String string, int i, int i_9_) {
	do {
	    try {
		Class98_Sub46_Sub17 class98_sub46_sub17
		    = Class185.method2628(i, -78, 2);
		class98_sub46_sub17.method1626((byte) -103);
		((Class98_Sub46_Sub17) class98_sub46_sub17).aString6052
		    = string;
		if (i_9_ >= 28)
		    break;
