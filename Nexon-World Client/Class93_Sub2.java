...
final class Class93_Sub2 extends Class93
{
	...
	try {
		...
		= Class98_Sub1.method945(Class244.anInt1860, var_ha,
					 (byte) 117, true);
	    if (i <= -47) {
		Class98_Sub46_Sub2_Sub2.aClass197_6296
		    = Class98_Sub46_Sub6.method1550(Class244.anInt1860, 18361,
						    var_ha);
		Class195.aClass43_1499
		    = Class98_Sub1.method945(Class269.anInt2026, var_ha,
					     (byte) 119, true);
		Class98_Sub46_Sub10.aClass197_6019
		    = Class98_Sub46_Sub6.method1550(Class269.anInt2026, 18361,
						    var_ha);
		Class98_Sub10_Sub34.aClass43_5730
		    = Class98_Sub1.method945(Class123_Sub1.anInt4742, var_ha,
					     (byte) 88, true);
		Class42_Sub1.aClass197_5354
		    = Class98_Sub46_Sub6.method1550(Class123_Sub1.anInt4742,
						    18361, var_ha);
	    }
	} catch (RuntimeException runtimeexception) {
	    throw Class64_Sub27.method667(runtimeexception,
