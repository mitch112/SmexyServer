...
final class Class98_Sub21 extends Class98
{
	...
	try {
		...
		if ((Class257.anInt1948 ^ 0xffffffff) == -3) {
			...
			Class81.aClass98_Sub7_620
			    = Class98_Sub7.method985(Class269.aClass207_2025,
			...
			Class202.aClass308_1550
			    = new Class308(Class94.aClass207_793,
					   Class98_Sub34.aClass207_4127);
		    Class98_Sub31_Sub2 class98_sub31_sub2
			...
			(Class81.aClass98_Sub7_620, 22050,
			 Class202.aClass308_1550, Class64_Sub1.aClass207_3641,
			 false)) {
			...
			if (Class22.anInt219 <= 0) {
			    ...
			    for (int i_0_ = 0;
				 ((Class77_Sub1.anIntArray3804.length
				   ^ 0xffffffff)
				  < (i_0_ ^ 0xffffffff));
				 i_0_++) {
			    ...
			    Class366.aClass98_Sub31_Sub2_3122.method1366
				((Class224_Sub3.anInt5037 < Class22.anInt219
				  ? Class224_Sub3.anInt5037
				  : Class22.anInt219),
				 (byte) 33);
			    for (int i_1_ = 0;
				 i_1_ < Class77_Sub1.anIntArray3804.length;
				 i_1_++) {
				Class366.aClass98_Sub31_Sub2_3122.method1363
				    (-17, i_1_,
			...
			if (Class116.aClass98_Sub31_Sub2_965 == null) {
			    if ((Class133.aLong3455 ^ 0xffffffffffffffffL)
				< -1L)
			...
			if (Class270.aClass268_2032 != null)
			    Class270.aClass268_2032.method3252
				(i + -13299,
				 Class366.aClass98_Sub31_Sub2_3122);
    ...
    static final int method1180(int i, byte i_3_, int i_4_, int i_5_,
				int i_6_) {
	try {
	    int i_7_ = 29 % ((i_3_ - 20) / 38);
	    int i_8_
		= (65536 - Class284_Sub2_Sub2.anIntArray6202[8192 * i_5_ / i]
		   >> -219666591);
	    return ((i_8_ * i_6_ >> -23038832)
		    + (i_4_ * (65536 - i_8_) >> 1646652976));
	} catch (RuntimeException runtimeexception) {
	    throw Class64_Sub27.method667(runtimeexception,
					  ("je.D(" + i + ',' + i_3_ + ','
					   + i_4_ + ',' + i_5_ + ',' + i_6_
    ...
    static {
	aShortArrayArray3987
	    = new short[][] { aShortArray3989, aShortArray3983,
			      aShortArray3988 };
    }
}
