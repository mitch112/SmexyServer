...
final class Class98_Sub46_Sub5 extends Class98_Sub46
{
	...
	try {
		...
		return false;
	    Class293 class293 = Class159.aClass293ArrayArray1252[i_2_][i_3_];
	    if ((i_0_ ^ 0xffffffff) == 0
		&& (((Class293) class293).anInt2354 ^ 0xffffffff) == -1) {
		for (Class98_Sub46_Sub8 class98_sub46_sub8
			 = ((Class98_Sub46_Sub8)
			    Class33.aClass148_315.method2418(32));
		     class98_sub46_sub8 != null;
		     class98_sub46_sub8
			 = ((Class98_Sub46_Sub8)
			    Class33.aClass148_315.method2417(i_1_ + 99))) {
		    if ((((Class98_Sub46_Sub8) class98_sub46_sub8).anInt5990
			 == 59)
			...
			|| (((Class98_Sub46_Sub8) class98_sub46_sub8).anInt5990
			    == 9)) {
			for (Class293 class293_4_
				 = Class159.method2509((((Class98_Sub46_Sub8)
							 class98_sub46_sub8)
							.anInt5993),
						       i_1_ ^ ~0x265d);
			     class293_4_ != null;
			     class293_4_
				 = Class360.method3910(true, class293_4_)) {
			    if ((((Class293) class293_4_).anInt2248
				 ^ 0xffffffff)
		...
		for (Class98_Sub46_Sub8 class98_sub46_sub8
		     ...
		     class98_sub46_sub8
			 = ((Class98_Sub46_Sub8)
			    Class33.aClass148_315.method2417(112))) {
		    if (i_0_ == (((Class98_Sub46_Sub8) class98_sub46_sub8)
				 .anInt5995)
			&& (((Class98_Sub46_Sub8) class98_sub46_sub8).anInt5993
			    == ((Class293) class293).anInt2248)
			&& (((((Class98_Sub46_Sub8) class98_sub46_sub8)
			      .anInt5990)
			     ^ 0xffffffff) == -60
			    || (((Class98_Sub46_Sub8) class98_sub46_sub8)
				.anInt5990) == 1006
	...
	try {
	    ...
	    i = (i_7_ * (0xff00 & i) & 0xff0000
		 | ~0xff00ff & i_7_ * (0xff00ff & i)) >>> 591549448;
	    int i_8_ = 255 + -i_7_;
	    return (((i_8_ * (i_6_ & 0xff00) & 0xff0000
		      | ~0xff00ff & (0xff00ff & i_6_) * i_8_)
		     >>> -1712218008)
		    + i);
	} catch (RuntimeException runtimeexception) {
	    throw Class64_Sub27.method667(runtimeexception,
	...
	try {
	    ((Class98_Sub46_Sub5) this).aClass246_Sub3_Sub4_Sub4_5969
