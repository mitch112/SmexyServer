...
public final class IDirect3DDevice extends IUnknown
{
	...
	(int i, int i_9_, int i_10_, int i_11_, int i_12_,
	...
	(int i, int i_18_, int i_19_, int i_20_,
	...
	(int i, int i_23_, int i_24_, int i_25_, int i_26_, boolean bool,
	...
	IDirect3DSurface idirect3dsurface;
	try {
	    IDirect3DSurface idirect3dsurface_33_ = new IDirect3DSurface(b);
	    int i = _GetDepthStencilSurface(idirect3dsurface_33_);
	    if (kg.b(-7175, i))
	...
	(IDirect3DSurface idirect3dsurface, int i, int i_35_, int i_36_,
	 int i_37_, IDirect3DSurface idirect3dsurface_38_, int i_39_,
	 int i_40_, int i_41_, int i_42_, int i_43_);
    
    private final native int _GetBackBuffer(int i, int i_44_, int i_45_,
					    IDirect3DSurface idirect3dsurface);
    
    public final int b(int i, float f, float f_46_, float f_47_, float f_48_) {
	int i_49_;
	try {
	    c[1] = f_46_;
	    c[3] = f_48_;
	...
	try {
	    IDirect3DEventQuery idirect3deventquery_50_
		= new IDirect3DEventQuery(b);
	...
	(int i, int i_55_, int i_56_, int i_57_, int i_58_, boolean bool,
	 IDirect3DSurface idirect3dsurface);
    ...
    public final IDirect3DCubeTexture a(int i, int i_61_, int i_62_, int i_63_,
					int i_64_) {
	IDirect3DCubeTexture idirect3dcubetexture;
	try {
	    IDirect3DCubeTexture idirect3dcubetexture_65_
		= new IDirect3DCubeTexture(b);
	    int i_66_ = _CreateCubeTexture(i, i_61_, i_62_, i_63_, i_64_,
	...
	try {
		...
		= new IDirect3DVertexShader(b);
	    int i = _CreateVertexShader(is, idirect3dvertexshader_68_);
	    if (kg.b(-7175, i))
		throw new jc(String.valueOf(i));
	    idirect3dvertexshader = idirect3dvertexshader_68_;
	} catch (RuntimeException runtimeexception) {
	...
	(int i, int i_69_, int i_70_, int i_71_,
	 IDirect3DSurface idirect3dsurface);
	...
	try {
	    ...
	    int i_77_ = _CreateVertexBuffer(i, i_73_, i_74_, i_75_,
	...
	(int i, int i_78_, int i_79_, int i_80_,
	 IDirect3DIndexBuffer idirect3dindexbuffer) {
	...
	try {
	    ...
	    int i_82_ = _CreateIndexBuffer(i, i_78_, i_79_, i_80_,
    ...
    public final IDirect3DSurface a(int i, int i_83_, int i_84_, int i_85_,
				    int i_86_, boolean bool) {
	IDirect3DSurface idirect3dsurface;
	try {
	    IDirect3DSurface idirect3dsurface_87_ = new IDirect3DSurface(b);
	    int i_88_ = _CreateRenderTarget(i, i_83_, i_84_, i_85_, i_86_,
					    bool, idirect3dsurface_87_);
	    if (kg.b(-7175, i_88_))
    ...
    public final IDirect3DVolumeTexture a(int i, int i_89_, int i_90_,
	...
	try {
		...
		= new IDirect3DVolumeTexture(b);
	    int i_96_
		= _CreateVolumeTexture(i, i_89_, i_90_, i_91_, i_92_, i_93_,
				       i_94_, idirect3dvolumetexture_95_);
	    if (kg.b(-7175, i_96_))
	...
	(int i, int i_97_, int i_98_, int i_99_, int i_100_, int i_101_,
	 int i_102_, IDirect3DVolumeTexture idirect3dvolumetexture);
	...
	(int i, IDirect3DVertexBuffer idirect3dvertexbuffer, int i_106_,
	 int i_107_);
    ...
    public final IDirect3DTexture a(int i, int i_109_, int i_110_, int i_111_,
				    int i_112_, int i_113_) {
	IDirect3DTexture idirect3dtexture;
	try {
	    IDirect3DTexture idirect3dtexture_114_ = new IDirect3DTexture(b);
	    int i_115_ = _CreateTexture(i, i_109_, i_110_, i_111_, i_112_,
					i_113_, idirect3dtexture_114_);
	    if (kg.b(-7175, i_115_))
	...
	try {
		...
		= new IDirect3DPixelShader(b);
	    int i = _CreatePixelShader(is, idirect3dpixelshader_119_);
	    if (kg.b(-7175, i))
		throw new jc(String.valueOf(i));
	    idirect3dpixelshader = idirect3dpixelshader_119_;
	} catch (RuntimeException runtimeexception) {
    ...
    public final IDirect3DSwapChain c(int i) {
	IDirect3DSwapChain idirect3dswapchain;
	try {
	    IDirect3DSwapChain idirect3dswapchain_120_
		= new IDirect3DSwapChain(b);
	    int i_121_ = _GetSwapChain(i, idirect3dswapchain_120_);
	    if (kg.b(-7175, i_121_))
    ...
    public final IDirect3DSurface d(int i) {
	IDirect3DSurface idirect3dsurface;
	try {
	    IDirect3DSurface idirect3dsurface_122_ = new IDirect3DSurface(b);
	    int i_123_ = _GetRenderTarget(i, idirect3dsurface_122_);
	    if (kg.b(-7175, i_123_))
