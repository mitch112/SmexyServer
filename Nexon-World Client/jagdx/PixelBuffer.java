...
public class PixelBuffer extends mfa implements Buffer
{
    ...
    public PixelBuffer(jaa var_jaa) {
	super(var_jaa);
	try {
	    init();
	} catch (RuntimeException runtimeexception) {
    ...
    public final void a(int[] is, int i, int i_4_, int i_5_) {
	try {
	    if (((i_4_ ^ 0xffffffff) > -1
		 | (is == null | -1 < (i ^ 0xffffffff)
		    | (is.length ^ 0xffffffff) > (i + i_5_ ^ 0xffffffff)))
    ...
    public final void b(int[] is, int i, int i_12_, int i_13_) {
	try {
	    if ((is == null | 0 > i
		 | (i + i_13_ ^ 0xffffffff) < (is.length ^ 0xffffffff)
		 | -1 < (i_12_ ^ 0xffffffff))
